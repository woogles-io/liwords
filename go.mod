...
require (
	...
	github.com/domino14/macondo v0.10.7
	github.com/domino14/word-golib v0.2.8
	...
	github.com/signalfx/splunk-otel-go/instrumentation/github.com/gomodule/redigo/splunkredigo v1.25.0
