...
var file_omgwords_service_omgwords_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xf4, 0x06, 0x0a, 0x10,
	...
	,
	...
	0x6e, 0x74, 0x42, 0x3c, 0x5a, 0x3a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
...
var file_omgwords_service_omgwords_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_omgwords_service_omgwords_proto_goTypes = []interface{}{
	...
	(*BroadcastGamesResponse_BroadcastGame)(nil), // 13: game_service.BroadcastGamesResponse.BroadcastGame
	(*ipc.PlayerInfo)(nil),                       // 14: ipc.PlayerInfo
	(*ipc.GameRules)(nil),                        // 15: ipc.GameRules
	(ipc.ChallengeRule)(0),                       // 16: ipc.ChallengeRule
	(*ipc.ClientGameplayEvent)(nil),              // 17: ipc.ClientGameplayEvent
	(*ipc.GameDocument)(nil),                     // 18: ipc.GameDocument
}
var file_omgwords_service_omgwords_proto_depIdxs = []int32{
	14, // 0: game_service.CreateBroadcastGameRequest.playersInfo:type_name -> ipc.PlayerInfo
	15, // 1: game_service.CreateBroadcastGameRequest.rules:type_name -> ipc.GameRules
	16, // 2: game_service.CreateBroadcastGameRequest.challenge_rule:type_name -> ipc.ChallengeRule
	13, // 3: game_service.BroadcastGamesResponse.games:type_name -> game_service.BroadcastGamesResponse.BroadcastGame
	17, // 4: game_service.AnnotatedGameEvent.event:type_name -> ipc.ClientGameplayEvent
	3,  // 5: game_service.GameEventService.CreateBroadcastGame:input_type -> game_service.CreateBroadcastGameRequest
	11, // 6: game_service.GameEventService.DeleteBroadcastGame:input_type -> game_service.DeleteBroadcastGameRequest
	9,  // 7: game_service.GameEventService.SendGameEvent:input_type -> game_service.AnnotatedGameEvent
	1,  // 8: game_service.GameEventService.SendTimePenaltyEvent:input_type -> game_service.TimePenaltyEvent
	2,  // 9: game_service.GameEventService.SendChallengeBonusEvent:input_type -> game_service.ChallengeBonusPointsEvent
	...
	0,  // 17: game_service.GameEventService.SendTimePenaltyEvent:output_type -> game_service.GameEventResponse
	0,  // 18: game_service.GameEventService.SendChallengeBonusEvent:output_type -> game_service.GameEventResponse
	0,  // 19: game_service.GameEventService.SetBroadcastGamePrivacy:output_type -> game_service.GameEventResponse
	8,  // 20: game_service.GameEventService.GetGamesForEditor:output_type -> game_service.BroadcastGamesResponse
	8,  // 21: game_service.GameEventService.GetMyUnfinishedGames:output_type -> game_service.BroadcastGamesResponse
	18, // 22: game_service.GameEventService.GetGameDocument:output_type -> ipc.GameDocument
