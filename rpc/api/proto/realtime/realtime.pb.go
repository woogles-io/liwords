...
var file_api_proto_realtime_realtime_proto_rawDesc = []byte{
	...
	0x43, 0x41, 0x53, 0x55, 0x41, 0x4c, 0x10, 0x01, 0x2a, 0x96, 0x08, 0x0a, 0x0b, 0x4d, 0x65, 0x73,
	...
	0x10, 0x1f, 0x12, 0x2e, 0x0a, 0x2a, 0x54, 0x4f, 0x55, 0x52, 0x4e, 0x41, 0x4d, 0x45, 0x4e, 0x54,
	...
	0x53, 0x41, 0x47, 0x45, 0x10, 0x26, 0x12, 0x12, 0x0a, 0x0e, 0x50, 0x52, 0x45, 0x53, 0x45, 0x4e,
...
var file_api_proto_realtime_realtime_proto_goTypes = []interface{}{
	...
	(*TournamentPerson)(nil),                  // 42: liwords.TournamentPerson
	(*TournamentPersons)(nil),                 // 43: liwords.TournamentPersons
	(*RoundControl)(nil),                      // 44: liwords.RoundControl
	(*DivisionControls)(nil),                  // 45: liwords.DivisionControls
	(*TournamentGame)(nil),                    // 46: liwords.TournamentGame
	(*Pairing)(nil),                           // 47: liwords.Pairing
	(*PlayerStanding)(nil),                    // 48: liwords.PlayerStanding
	(*RoundStandings)(nil),                    // 49: liwords.RoundStandings
	(*DivisionPairingsResponse)(nil),          // 50: liwords.DivisionPairingsResponse
	(*PlayersAddedOrRemovedResponse)(nil),     // 51: liwords.PlayersAddedOrRemovedResponse
	(*DivisionRoundControls)(nil),             // 52: liwords.DivisionRoundControls
	(*DivisionControlsResponse)(nil),          // 53: liwords.DivisionControlsResponse
	(*TournamentDivisionDataResponse)(nil),    // 54: liwords.TournamentDivisionDataResponse
	(*FullTournamentDivisions)(nil),           // 55: liwords.FullTournamentDivisions
	(*TournamentFinishedResponse)(nil),        // 56: liwords.TournamentFinishedResponse
	(*TournamentDataResponse)(nil),            // 57: liwords.TournamentDataResponse
	(*TournamentDivisionDeletedResponse)(nil), // 58: liwords.TournamentDivisionDeletedResponse
	(*JoinPath)(nil),                          // 59: liwords.JoinPath
	(*UnjoinRealm)(nil),                       // 60: liwords.UnjoinRealm
	nil,                                       // 61: liwords.GameEndedEvent.ScoresEntry
	nil,                                       // 62: liwords.GameEndedEvent.NewRatingsEntry
	nil,                                       // 63: liwords.GameEndedEvent.RatingDeltasEntry
	(*TournamentGameEndedEvent_Player)(nil),   // 64: liwords.TournamentGameEndedEvent.Player
	nil,                                       // 65: liwords.DivisionPairingsResponse.DivisionStandingsEntry
	nil,                                       // 66: liwords.PlayersAddedOrRemovedResponse.DivisionStandingsEntry
	nil,                                       // 67: liwords.DivisionRoundControls.DivisionStandingsEntry
	nil,                                       // 68: liwords.TournamentDivisionDataResponse.StandingsEntry
	nil,                                       // 69: liwords.TournamentDivisionDataResponse.PairingMapEntry
	nil,                                       // 70: liwords.FullTournamentDivisions.DivisionsEntry
	(macondo.ChallengeRule)(0),                // 71: macondo.ChallengeRule
	(*macondo.GameEvent)(nil),                 // 72: macondo.GameEvent
	(macondo.PlayState)(0),                    // 73: macondo.PlayState
	(*macondo.GameHistory)(nil),               // 74: macondo.GameHistory
...
var file_api_proto_realtime_realtime_proto_depIdxs = []int32{
	...
	71, // 1: liwords.GameRequest.challenge_rule:type_name -> macondo.ChallengeRule
	...
	72, // 14: liwords.ServerGameplayEvent.event:type_name -> macondo.GameEvent
	73, // 15: liwords.ServerGameplayEvent.playing:type_name -> macondo.PlayState
	71, // 16: liwords.ServerChallengeResultEvent.challenge_rule:type_name -> macondo.ChallengeRule
	61, // 17: liwords.GameEndedEvent.scores:type_name -> liwords.GameEndedEvent.ScoresEntry
	62, // 18: liwords.GameEndedEvent.new_ratings:type_name -> liwords.GameEndedEvent.NewRatingsEntry
	3,  // 19: liwords.GameEndedEvent.end_reason:type_name -> liwords.GameEndReason
	63, // 20: liwords.GameEndedEvent.rating_deltas:type_name -> liwords.GameEndedEvent.RatingDeltasEntry
	74, // 21: liwords.GameEndedEvent.history:type_name -> macondo.GameHistory
	64, // 22: liwords.TournamentGameEndedEvent.players:type_name -> liwords.TournamentGameEndedEvent.Player
	3,  // 23: liwords.TournamentGameEndedEvent.end_reason:type_name -> liwords.GameEndReason
	75, // 24: liwords.TournamentRoundStarted.deadline:type_name -> google.protobuf.Timestamp
	74, // 25: liwords.GameHistoryRefresher.history:type_name -> macondo.GameHistory
	7,  // 26: liwords.ClientGameplayEvent.type:type_name -> liwords.ClientGameplayEvent.EventType
	42, // 27: liwords.TournamentPersons.persons:type_name -> liwords.TournamentPerson
	...
	9,  // 30: liwords.DivisionControls.game_request:type_name -> liwords.GameRequest
	4,  // 31: liwords.DivisionControls.suspended_result:type_name -> liwords.TournamentGameResult
	...
	46, // 34: liwords.Pairing.games:type_name -> liwords.TournamentGame
	4,  // 35: liwords.Pairing.outcomes:type_name -> liwords.TournamentGameResult
	48, // 36: liwords.RoundStandings.standings:type_name -> liwords.PlayerStanding
	47, // 37: liwords.DivisionPairingsResponse.division_pairings:type_name -> liwords.Pairing
	65, // 38: liwords.DivisionPairingsResponse.division_standings:type_name -> liwords.DivisionPairingsResponse.DivisionStandingsEntry
	43, // 39: liwords.PlayersAddedOrRemovedResponse.players:type_name -> liwords.TournamentPersons
	47, // 40: liwords.PlayersAddedOrRemovedResponse.division_pairings:type_name -> liwords.Pairing
	66, // 41: liwords.PlayersAddedOrRemovedResponse.division_standings:type_name -> liwords.PlayersAddedOrRemovedResponse.DivisionStandingsEntry
	44, // 42: liwords.DivisionRoundControls.round_controls:type_name -> liwords.RoundControl
	47, // 43: liwords.DivisionRoundControls.division_pairings:type_name -> liwords.Pairing
	67, // 44: liwords.DivisionRoundControls.division_standings:type_name -> liwords.DivisionRoundControls.DivisionStandingsEntry
	45, // 45: liwords.DivisionControlsResponse.division_controls:type_name -> liwords.DivisionControls
	43, // 46: liwords.TournamentDivisionDataResponse.players:type_name -> liwords.TournamentPersons
	68, // 47: liwords.TournamentDivisionDataResponse.standings:type_name -> liwords.TournamentDivisionDataResponse.StandingsEntry
	69, // 48: liwords.TournamentDivisionDataResponse.pairing_map:type_name -> liwords.TournamentDivisionDataResponse.PairingMapEntry
	45, // 49: liwords.TournamentDivisionDataResponse.controls:type_name -> liwords.DivisionControls
	44, // 50: liwords.TournamentDivisionDataResponse.round_controls:type_name -> liwords.RoundControl
	70, // 51: liwords.FullTournamentDivisions.divisions:type_name -> liwords.FullTournamentDivisions.DivisionsEntry
	43, // 52: liwords.TournamentDataResponse.directors:type_name -> liwords.TournamentPersons
	75, // 53: liwords.TournamentDataResponse.start_time:type_name -> google.protobuf.Timestamp
	4,  // 54: liwords.TournamentGameEndedEvent.Player.result:type_name -> liwords.TournamentGameResult
	49, // 55: liwords.DivisionPairingsResponse.DivisionStandingsEntry.value:type_name -> liwords.RoundStandings
	49, // 56: liwords.PlayersAddedOrRemovedResponse.DivisionStandingsEntry.value:type_name -> liwords.RoundStandings
	49, // 57: liwords.DivisionRoundControls.DivisionStandingsEntry.value:type_name -> liwords.RoundStandings
	49, // 58: liwords.TournamentDivisionDataResponse.StandingsEntry.value:type_name -> liwords.RoundStandings
	47, // 59: liwords.TournamentDivisionDataResponse.PairingMapEntry.value:type_name -> liwords.Pairing
	54, // 60: liwords.FullTournamentDivisions.DivisionsEntry.value:type_name -> liwords.TournamentDivisionDataResponse
