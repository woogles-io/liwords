...
type ReadyForTournamentGame struct {
	...
	Division     string `protobuf:"bytes,2,opt,name=division,proto3" json:"division,omitempty"`
	Round        int32  `protobuf:"varint,3,opt,name=round,proto3" json:"round,omitempty"`
	GameIndex    int32  `protobuf:"varint,4,opt,name=game_index,json=gameIndex,proto3" json:"game_index,omitempty"` // within a matchplay type tournament where several
	// games share a round.
	Unready bool `protobuf:"varint,5,opt,name=unready,proto3" json:"unready,omitempty"` // if true, this is a NOT-ready message.
}
...
type TournamentDivisionDataResponse struct {
	...
	// one will be non nil
	Division          map[string]*PlayerRoundInfo `protobuf:"bytes,5,rep,name=division,proto3" json:"division,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	CurrentRound      int32                       `protobuf:"varint,6,opt,name=current_round,json=currentRound,proto3" json:"current_round,omitempty"`
	Standings         []*PlayerStanding           `protobuf:"bytes,7,rep,name=standings,proto3" json:"standings,omitempty"`
	PlayersProperties []*PlayerProperties         `protobuf:"bytes,8,rep,name=players_properties,json=playersProperties,proto3" json:"players_properties,omitempty"`
}
...
func (x *TournamentDivisionDataResponse) GetDivision() map[string]*PlayerRoundInfo {
	if x != nil {
		return x.Division
	}
	return nil
...
func (x *TournamentDivisionDataResponse) GetStandings() []*PlayerStanding {
	if x != nil {
		return x.Standings
	}
	return nil
...
var file_api_proto_realtime_realtime_proto_rawDesc = []byte{
	...
	0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xb5,
	...
	0x69, 0x6d, 0x65, 0x1a, 0x71, 0x0a, 0x06, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x12, 0x1a, 0x0a,
	...
	0x0a, 0x06, 0x52, 0x45, 0x53, 0x49, 0x47, 0x4e, 0x10, 0x04, 0x22, 0xa8, 0x01, 0x0a, 0x16, 0x52,
	...
	0x6e, 0x72, 0x65, 0x61, 0x64, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x75, 0x6e,
	...
	0x61, 0x75, 0x74, 0x6f, 0x53, 0x74, 0x61, 0x72, 0x74, 0x22, 0xa1, 0x01, 0x0a, 0x0e, 0x54, 0x6f,
	...
	0x67, 0x61, 0x6d, 0x65, 0x45, 0x6e, 0x64, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0x2c, 0x0a,
	...
	0x28, 0x08, 0x52, 0x07, 0x72, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64, 0x22, 0xb8, 0x01, 0x0a, 0x0f,
	...
	0x6d, 0x6f, 0x76, 0x65, 0x64, 0x22, 0x43, 0x0a, 0x0f, 0x43, 0x6c, 0x61, 0x73, 0x73, 0x69, 0x63,
	...
	0x66, 0x6f, 0x52, 0x06, 0x6d, 0x61, 0x74, 0x72, 0x69, 0x78, 0x22, 0xf4, 0x03, 0x0a, 0x1e, 0x54,
	...
	,
	...
	0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6c,
	...
	0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x1a, 0x55, 0x0a, 0x0d, 0x44, 0x69,
	0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b,
	...
	0x01, 0x22, 0xcf, 0x01, 0x0a, 0x17, 0x46, 0x75, 0x6c, 0x6c, 0x54, 0x6f, 0x75, 0x72, 0x6e, 0x61,
	...
	0x79, 0x52, 0x09, 0x64, 0x69, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x65, 0x0a, 0x0e,
...
var file_api_proto_realtime_realtime_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_api_proto_realtime_realtime_proto_goTypes = []interface{}{
	...
	(*ClassicDivision)(nil),                   // 45: liwords.ClassicDivision
	(*TournamentDivisionDataResponse)(nil),    // 46: liwords.TournamentDivisionDataResponse
	(*FullTournamentDivisions)(nil),           // 47: liwords.FullTournamentDivisions
	(*TournamentDataResponse)(nil),            // 48: liwords.TournamentDataResponse
	(*TournamentDivisionDeletedResponse)(nil), // 49: liwords.TournamentDivisionDeletedResponse
	(*JoinPath)(nil),                          // 50: liwords.JoinPath
	(*UnjoinRealm)(nil),                       // 51: liwords.UnjoinRealm
	nil,                                       // 52: liwords.GameEndedEvent.ScoresEntry
	nil,                                       // 53: liwords.GameEndedEvent.NewRatingsEntry
	nil,                                       // 54: liwords.GameEndedEvent.RatingDeltasEntry
	(*TournamentGameEndedEvent_Player)(nil),   // 55: liwords.TournamentGameEndedEvent.Player
	nil,                                       // 56: liwords.TournamentPersons.PersonsEntry
	nil,                                       // 57: liwords.TournamentDivisionDataResponse.DivisionEntry
	nil,                                       // 58: liwords.FullTournamentDivisions.DivisionsEntry
	(macondo.ChallengeRule)(0),                // 59: macondo.ChallengeRule
	(*macondo.GameEvent)(nil),                 // 60: macondo.GameEvent
	(macondo.PlayState)(0),                    // 61: macondo.PlayState
	(*macondo.GameHistory)(nil),               // 62: macondo.GameHistory
...
var file_api_proto_realtime_realtime_proto_depIdxs = []int32{
	...
	59, // 1: liwords.GameRequest.challenge_rule:type_name -> macondo.ChallengeRule
	...
	60, // 13: liwords.ServerGameplayEvent.event:type_name -> macondo.GameEvent
	61, // 14: liwords.ServerGameplayEvent.playing:type_name -> macondo.PlayState
	59, // 15: liwords.ServerChallengeResultEvent.challenge_rule:type_name -> macondo.ChallengeRule
	52, // 16: liwords.GameEndedEvent.scores:type_name -> liwords.GameEndedEvent.ScoresEntry
	53, // 17: liwords.GameEndedEvent.new_ratings:type_name -> liwords.GameEndedEvent.NewRatingsEntry
	3,  // 18: liwords.GameEndedEvent.end_reason:type_name -> liwords.GameEndReason
	54, // 19: liwords.GameEndedEvent.rating_deltas:type_name -> liwords.GameEndedEvent.RatingDeltasEntry
	62, // 20: liwords.GameEndedEvent.history:type_name -> macondo.GameHistory
	55, // 21: liwords.TournamentGameEndedEvent.players:type_name -> liwords.TournamentGameEndedEvent.Player
	3,  // 22: liwords.TournamentGameEndedEvent.end_reason:type_name -> liwords.GameEndReason
	63, // 23: liwords.TournamentRoundStarted.deadline:type_name -> google.protobuf.Timestamp
	62, // 24: liwords.GameHistoryRefresher.history:type_name -> macondo.GameHistory
	7,  // 25: liwords.ClientGameplayEvent.type:type_name -> liwords.ClientGameplayEvent.EventType
	56, // 26: liwords.TournamentPersons.persons:type_name -> liwords.TournamentPersons.PersonsEntry
	...
	63, // 31: liwords.TournamentControls.start_time:type_name -> google.protobuf.Timestamp
	...
	43, // 36: liwords.ClassicDivision.matrix:type_name -> liwords.PlayerRoundInfo
	40, // 37: liwords.TournamentDivisionDataResponse.controls:type_name -> liwords.TournamentControls
	57, // 38: liwords.TournamentDivisionDataResponse.division:type_name -> liwords.TournamentDivisionDataResponse.DivisionEntry
	44, // 39: liwords.TournamentDivisionDataResponse.standings:type_name -> liwords.PlayerStanding
	42, // 40: liwords.TournamentDivisionDataResponse.players_properties:type_name -> liwords.PlayerProperties
	58, // 41: liwords.FullTournamentDivisions.divisions:type_name -> liwords.FullTournamentDivisions.DivisionsEntry
	38, // 42: liwords.TournamentDataResponse.directors:type_name -> liwords.TournamentPersons
	63, // 43: liwords.TournamentDataResponse.start_time:type_name -> google.protobuf.Timestamp
	4,  // 44: liwords.TournamentGameEndedEvent.Player.result:type_name -> liwords.TournamentGameResult
	43, // 45: liwords.TournamentDivisionDataResponse.DivisionEntry.value:type_name -> liwords.PlayerRoundInfo
	46, // 46: liwords.FullTournamentDivisions.DivisionsEntry.value:type_name -> liwords.TournamentDivisionDataResponse
