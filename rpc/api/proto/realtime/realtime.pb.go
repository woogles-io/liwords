...
var file_api_proto_realtime_realtime_proto_rawDesc = []byte{
	...
	0x43, 0x45, 0x4c, 0x4c, 0x45, 0x44, 0x10, 0x07, 0x42, 0x34, 0x5a, 0x32, 0x67, 0x69, 0x74, 0x68,
...
var file_api_proto_realtime_realtime_proto_goTypes = []interface{}{
	...
	(*TournamentGameEndedEvent)(nil),   // 26: liwords.TournamentGameEndedEvent
	(*GameHistoryRefresher)(nil),       // 27: liwords.GameHistoryRefresher
	(*NewGameEvent)(nil),               // 28: liwords.NewGameEvent
	(*ErrorMessage)(nil),               // 29: liwords.ErrorMessage
	(*ServerMessage)(nil),              // 30: liwords.ServerMessage
	(*ClientGameplayEvent)(nil),        // 31: liwords.ClientGameplayEvent
	(*TimedOut)(nil),                   // 32: liwords.TimedOut
	(*DeclineMatchRequest)(nil),        // 33: liwords.DeclineMatchRequest
	(*JoinPath)(nil),                   // 34: liwords.JoinPath
	(*UnjoinRealm)(nil),                // 35: liwords.UnjoinRealm
	(*GameMeta_UserMeta)(nil),          // 36: liwords.GameMeta.UserMeta
	nil,                                // 37: liwords.GameEndedEvent.ScoresEntry
	nil,                                // 38: liwords.GameEndedEvent.NewRatingsEntry
	nil,                                // 39: liwords.GameEndedEvent.RatingDeltasEntry
	nil,                                // 40: liwords.TournamentGameEndedEvent.ScoresEntry
	(macondo.ChallengeRule)(0),         // 41: macondo.ChallengeRule
	(*macondo.GameEvent)(nil),          // 42: macondo.GameEvent
	(macondo.PlayState)(0),             // 43: macondo.PlayState
	(*macondo.GameHistory)(nil),        // 44: macondo.GameHistory
}
var file_api_proto_realtime_realtime_proto_depIdxs = []int32{
	5,  // 0: liwords.GameRequest.rules:type_name -> liwords.GameRules
	41, // 1: liwords.GameRequest.challenge_rule:type_name -> macondo.ChallengeRule
	...
	36, // 4: liwords.GameMeta.users:type_name -> liwords.GameMeta.UserMeta
	...
	42, // 16: liwords.ServerGameplayEvent.event:type_name -> macondo.GameEvent
	43, // 17: liwords.ServerGameplayEvent.playing:type_name -> macondo.PlayState
	41, // 18: liwords.ServerChallengeResultEvent.challenge_rule:type_name -> macondo.ChallengeRule
	37, // 19: liwords.GameEndedEvent.scores:type_name -> liwords.GameEndedEvent.ScoresEntry
	38, // 20: liwords.GameEndedEvent.new_ratings:type_name -> liwords.GameEndedEvent.NewRatingsEntry
	3,  // 21: liwords.GameEndedEvent.end_reason:type_name -> liwords.GameEndReason
	39, // 22: liwords.GameEndedEvent.rating_deltas:type_name -> liwords.GameEndedEvent.RatingDeltasEntry
	44, // 23: liwords.GameEndedEvent.history:type_name -> macondo.GameHistory
	40, // 24: liwords.TournamentGameEndedEvent.scores:type_name -> liwords.TournamentGameEndedEvent.ScoresEntry
	3,  // 25: liwords.TournamentGameEndedEvent.end_reason:type_name -> liwords.GameEndReason
	44, // 26: liwords.GameHistoryRefresher.history:type_name -> macondo.GameHistory
	4,  // 27: liwords.ClientGameplayEvent.type:type_name -> liwords.ClientGameplayEvent.EventType
