...
func (x *Pong) Reset() {
	*x = Pong{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_proto_realtime_ipc_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Pong) Descriptor() ([]byte, []int) {
	return file_api_proto_realtime_ipc_proto_rawDescGZIP(), []int{3}
}
...
var file_api_proto_realtime_ipc_proto_rawDesc = []byte{
	...
	0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x61, 0x6c, 0x6d, 0x73, 0x22,
	0x18, 0x0a, 0x04, 0x50, 0x6f, 0x6e, 0x67, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x70, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x03, 0x69, 0x70, 0x73, 0x42, 0x34, 0x5a, 0x32, 0x67, 0x69, 0x74,
...
var file_api_proto_realtime_ipc_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
func file_api_proto_realtime_ipc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_proto_realtime_ipc_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pong); i {
			case 0:
				return &v.state
			case 1:
