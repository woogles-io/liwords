...
var file_api_proto_puzzle_service_puzzle_service_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x73, 0x74, 0x2a, 0x3a, 0x0a, 0x0c, 0x50, 0x75, 0x7a, 0x7a, 0x6c, 0x65, 0x53, 0x74,
...
var file_api_proto_puzzle_service_puzzle_service_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_api_proto_puzzle_service_puzzle_service_proto_goTypes = []interface{}{
	...
	(*macondo.GameEvent)(nil),               // 15: macondo.GameEvent
	(*timestamppb.Timestamp)(nil),           // 16: google.protobuf.Timestamp
	(*macondo.GameHistory)(nil),             // 17: macondo.GameHistory
	(*ipc.ClientGameplayEvent)(nil),         // 18: ipc.ClientGameplayEvent
	(*macondo.PuzzleGenerationRequest)(nil), // 19: macondo.PuzzleGenerationRequest
}
var file_api_proto_puzzle_service_puzzle_service_proto_depIdxs = []int32{
	15, // 0: puzzle_service.AnswerResponse.correct_answer:type_name -> macondo.GameEvent
	0,  // 1: puzzle_service.AnswerResponse.status:type_name -> puzzle_service.PuzzleStatus
	16, // 2: puzzle_service.AnswerResponse.first_attempt_time:type_name -> google.protobuf.Timestamp
	16, // 3: puzzle_service.AnswerResponse.last_attempt_time:type_name -> google.protobuf.Timestamp
	17, // 4: puzzle_service.PuzzleResponse.history:type_name -> macondo.GameHistory
	6,  // 5: puzzle_service.PuzzleResponse.answer:type_name -> puzzle_service.AnswerResponse
	18, // 6: puzzle_service.SubmissionRequest.answer:type_name -> ipc.ClientGameplayEvent
	6,  // 7: puzzle_service.SubmissionResponse.answer:type_name -> puzzle_service.AnswerResponse
	19, // 8: puzzle_service.PuzzleGenerationJobRequest.request:type_name -> macondo.PuzzleGenerationRequest
	...
	8,  // 12: puzzle_service.PuzzleService.SubmitAnswer:input_type -> puzzle_service.SubmissionRequest
	10, // 13: puzzle_service.PuzzleService.GetPreviousPuzzleId:input_type -> puzzle_service.PreviousPuzzleRequest
	12, // 14: puzzle_service.PuzzleService.SetPuzzleVote:input_type -> puzzle_service.PuzzleVoteRequest
	...
	7,  // 17: puzzle_service.PuzzleService.GetPuzzle:output_type -> puzzle_service.PuzzleResponse
	9,  // 18: puzzle_service.PuzzleService.SubmitAnswer:output_type -> puzzle_service.SubmissionResponse
	11, // 19: puzzle_service.PuzzleService.GetPreviousPuzzleId:output_type -> puzzle_service.PreviousPuzzleResponse
	13, // 20: puzzle_service.PuzzleService.SetPuzzleVote:output_type -> puzzle_service.PuzzleVoteResponse
