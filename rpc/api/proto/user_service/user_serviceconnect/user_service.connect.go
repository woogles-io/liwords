...
var (
	authenticationServiceServiceDescriptor                    = user_service.File_user_service_user_service_proto.Services().ByName("AuthenticationService")
	...
	registrationServiceServiceDescriptor                      = user_service.File_user_service_user_service_proto.Services().ByName("RegistrationService")
	registrationServiceRegisterMethodDescriptor               = registrationServiceServiceDescriptor.Methods().ByName("Register")
	profileServiceServiceDescriptor                           = user_service.File_user_service_user_service_proto.Services().ByName("ProfileService")
	...
	autocompleteServiceServiceDescriptor                      = user_service.File_user_service_user_service_proto.Services().ByName("AutocompleteService")
	autocompleteServiceGetCompletionMethodDescriptor          = autocompleteServiceServiceDescriptor.Methods().ByName("GetCompletion")
	socializeServiceServiceDescriptor                         = user_service.File_user_service_user_service_proto.Services().ByName("SocializeService")
