...
var file_proto_ipc_ipc_proto_rawDesc = []byte{
	...
	0xb5, 0x09, 0x0a, 0x0b, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x55, 0x4d, 0x45, 0x4e, 0x54, 0x10, 0x2d, 0x42, 0x70, 0x0a, 0x07, 0x63, 0x6f, 0x6d, 0x2e, 0x69,
	0x70, 0x63, 0x42, 0x08, 0x49, 0x70, 0x63, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2f,
...
var (
	...
	file_proto_ipc_ipc_proto_rawDescData = file_proto_ipc_ipc_proto_rawDesc
)

func file_proto_ipc_ipc_proto_rawDescGZIP() []byte {
	file_proto_ipc_ipc_proto_rawDescOnce.Do(func() {
		file_proto_ipc_ipc_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_ipc_ipc_proto_rawDescData)
	})
...
var file_proto_ipc_ipc_proto_goTypes = []interface{}{
...
func file_proto_ipc_ipc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_ipc_ipc_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_ipc_ipc_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_ipc_ipc_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_ipc_ipc_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_ipc_ipc_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pong); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_ipc_ipc_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_ipc_ipc_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_ipc_ipc_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_ipc_ipc_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_proto_ipc_ipc_proto_rawDesc = nil
