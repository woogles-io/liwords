...
const (
	...
	MessageType_BROADCAST_UPDATED               MessageType = 52
	MessageType_BROADCAST_GAMES_UPDATED         MessageType = 53
)
...
var (
	MessageType_name = map[int32]string{
		...
		52: "BROADCAST_UPDATED",
		53: "BROADCAST_GAMES_UPDATED",
	}
...
type BroadcastUpdatedEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *BroadcastUpdatedEvent) Reset() {
	*x = BroadcastUpdatedEvent{}
	mi := &file_proto_ipc_ipc_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BroadcastUpdatedEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BroadcastUpdatedEvent) ProtoMessage() {}

func (x *BroadcastUpdatedEvent) ProtoReflect() protoreflect.Message {
	mi := &file_proto_ipc_ipc_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BroadcastUpdatedEvent.ProtoReflect.Descriptor instead.
func (*BroadcastUpdatedEvent) Descriptor() ([]byte, []int) {
	return file_proto_ipc_ipc_proto_rawDescGZIP(), []int{1}
}

func (x *BroadcastUpdatedEvent) GetSlug() string {
	if x != nil {
		return x.Slug
	}
	return ""
...
func (x *BroadcastUpdatedEvent) GetCurrentRound() int32 {
	if x != nil {
...
type BroadcastGamesUpdatedEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Slug          string                 `protobuf:"bytes,1,opt,name=slug,proto3" json:"slug,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *BroadcastGamesUpdatedEvent) Reset() {
	*x = BroadcastGamesUpdatedEvent{}
	mi := &file_proto_ipc_ipc_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BroadcastGamesUpdatedEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BroadcastGamesUpdatedEvent) ProtoMessage() {}

func (x *BroadcastGamesUpdatedEvent) ProtoReflect() protoreflect.Message {
	mi := &file_proto_ipc_ipc_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BroadcastGamesUpdatedEvent.ProtoReflect.Descriptor instead.
func (*BroadcastGamesUpdatedEvent) Descriptor() ([]byte, []int) {
	return file_proto_ipc_ipc_proto_rawDescGZIP(), []int{2}
}

func (x *BroadcastGamesUpdatedEvent) GetSlug() string {
	if x != nil {
		return x.Slug
	}
	return ""
...
const file_proto_ipc_ipc_proto_rawDesc = "" +
	...
	"\x15BroadcastUpdatedEvent\x12\x12\n" +
	"\x04slug\x18\x01 \x01(\tR\x04slug\x12#\n" +
	"\rcurrent_round\x18\x02 \x01(\x05R\fcurrentRound\"0\n" +
	"\x1aBroadcastGamesUpdatedEvent\x12\x12\n" +
	...
	"\x11ANALYSIS_COMPLETE\x103\x12\x15\n" +
	"\x11BROADCAST_UPDATED\x104\x12\x1b\n" +
	"\x17BROADCAST_GAMES_UPDATED\x105Bp\n" +
...
var file_proto_ipc_ipc_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_proto_ipc_ipc_proto_goTypes = []any{
	...
	(*BroadcastUpdatedEvent)(nil),      // 2: ipc.BroadcastUpdatedEvent
	(*BroadcastGamesUpdatedEvent)(nil), // 3: ipc.BroadcastGamesUpdatedEvent
	(*RegisterRealmRequest)(nil),       // 4: ipc.RegisterRealmRequest
	(*RegisterRealmResponse)(nil),      // 5: ipc.RegisterRealmResponse
	(*InitRealmInfo)(nil),              // 6: ipc.InitRealmInfo
	(*LagMeasurement)(nil),             // 7: ipc.LagMeasurement
	(*Pong)(nil),                       // 8: ipc.Pong
	(*ServerMessage)(nil),              // 9: ipc.ServerMessage
	(*JoinPath)(nil),                   // 10: ipc.JoinPath
	(*UnjoinRealm)(nil),                // 11: ipc.UnjoinRealm
}
