...
type RoundControl struct {
	...
	SpreadCapOverride           uint32                 `protobuf:"varint,12,opt,name=spread_cap_override,json=spreadCapOverride,proto3" json:"spread_cap_override,omitempty"`
	// We use this boolean to differentiate between a disabled override
	// (i.e. using the division default) and an enabled override set to 0
...
var file_proto_ipc_tournament_proto_rawDesc = string([]byte{
	...
	0x0d, 0x52, 0x11, 0x73, 0x70, 0x72, 0x65, 0x61, 0x64, 0x43, 0x61, 0x70, 0x4f, 0x76, 0x65, 0x72,
	...
	0x65, 0x61, 0x64, 0x5f, 0x63, 0x61, 0x70, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x73,
