...
type PairRequest struct {
	...
	Round                      int32                  `protobuf:"varint,21,opt,name=round,proto3" json:"round,omitempty"`
...
func (x *PairRequest) GetRound() int32 {
	if x != nil {
		return x.Round
	}
	return 0
...
const file_proto_ipc_pair_proto_rawDesc = "" +
	...
	"\aresults\x18\x01 \x03(\x05R\aresults\"\xc1\a\n" +
	"\vPairRequest\x120\n" +
	...
	"\rtop_down_byes\x18\x14 \x01(\bR\vtopDownByes\x12\x14\n" +
	"\x05round\x18\x15 \x01(\x05R\x05round\x12\x16\n" +
	"\x06factor\x18\x16 \x01(\x05R\x06factor\x124\n" +
	"\x16initial_nonperf_rounds\x18\x17 \x01(\x05R\x14initialNonperfRounds\"\xf0\x01\n" +
	"\fPairResponse\x12-\n" +
	"\n" +
