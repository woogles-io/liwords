...
var file_api_proto_ipc_omgwords_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x09, 0x67, 0x61, 0x6d, 0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0xcd, 0x01,
	...
	0x4c, 0x10, 0x01, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_api_proto_ipc_omgwords_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_api_proto_ipc_omgwords_proto_goTypes = []interface{}{
	...
	(*InstantiateGame)(nil),            // 11: ipc.InstantiateGame
	(*GameDeletion)(nil),               // 12: ipc.GameDeletion
	(*ActiveGamePlayer)(nil),           // 13: ipc.ActiveGamePlayer
	(*ActiveGameEntry)(nil),            // 14: ipc.ActiveGameEntry
	(*ReadyForGame)(nil),               // 15: ipc.ReadyForGame
	(*ServerGameplayEvent)(nil),        // 16: ipc.ServerGameplayEvent
	(*ServerChallengeResultEvent)(nil), // 17: ipc.ServerChallengeResultEvent
	(*GameEndedEvent)(nil),             // 18: ipc.GameEndedEvent
	(*RematchStartedEvent)(nil),        // 19: ipc.RematchStartedEvent
	(*NewGameEvent)(nil),               // 20: ipc.NewGameEvent
	(*TimedOut)(nil),                   // 21: ipc.TimedOut
	nil,                                // 22: ipc.GameEndedEvent.ScoresEntry
	nil,                                // 23: ipc.GameEndedEvent.NewRatingsEntry
	nil,                                // 24: ipc.GameEndedEvent.RatingDeltasEntry
	(macondo.ChallengeRule)(0),         // 25: macondo.ChallengeRule
	(macondo.BotRequest_BotCode)(0),    // 26: macondo.BotRequest.BotCode
	(*timestamppb.Timestamp)(nil),      // 27: google.protobuf.Timestamp
	(*macondo.GameHistory)(nil),        // 28: macondo.GameHistory
	(*macondo.GameEvent)(nil),          // 29: macondo.GameEvent
	(macondo.PlayState)(0),             // 30: macondo.PlayState
}
var file_api_proto_ipc_omgwords_proto_depIdxs = []int32{
	...
	25, // 2: ipc.GameRequest.challenge_rule:type_name -> macondo.ChallengeRule
	1,  // 3: ipc.GameRequest.game_mode:type_name -> ipc.GameMode
	2,  // 4: ipc.GameRequest.rating_mode:type_name -> ipc.RatingMode
	26, // 5: ipc.GameRequest.bot_type:type_name -> macondo.BotRequest.BotCode
	27, // 6: ipc.GameMetaEvent.timestamp:type_name -> google.protobuf.Timestamp
	4,  // 7: ipc.GameMetaEvent.type:type_name -> ipc.GameMetaEvent.EventType
	28, // 8: ipc.GameHistoryRefresher.history:type_name -> macondo.GameHistory
	8,  // 9: ipc.GameHistoryRefresher.outstanding_event:type_name -> ipc.GameMetaEvent
	7,  // 10: ipc.InstantiateGame.game_request:type_name -> ipc.GameRequest
	10, // 11: ipc.InstantiateGame.tournament_data:type_name -> ipc.TournamentDataForGame
	13, // 12: ipc.ActiveGameEntry.player:type_name -> ipc.ActiveGamePlayer
	29, // 13: ipc.ServerGameplayEvent.event:type_name -> macondo.GameEvent
	30, // 14: ipc.ServerGameplayEvent.playing:type_name -> macondo.PlayState
	25, // 15: ipc.ServerChallengeResultEvent.challenge_rule:type_name -> macondo.ChallengeRule
	22, // 16: ipc.GameEndedEvent.scores:type_name -> ipc.GameEndedEvent.ScoresEntry
	23, // 17: ipc.GameEndedEvent.new_ratings:type_name -> ipc.GameEndedEvent.NewRatingsEntry
	0,  // 18: ipc.GameEndedEvent.end_reason:type_name -> ipc.GameEndReason
	24, // 19: ipc.GameEndedEvent.rating_deltas:type_name -> ipc.GameEndedEvent.RatingDeltasEntry
	28, // 20: ipc.GameEndedEvent.history:type_name -> macondo.GameHistory
