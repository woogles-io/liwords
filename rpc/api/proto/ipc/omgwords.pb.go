...
var file_api_proto_ipc_omgwords_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x2a, 0x9c, 0x01,
	...
	0x43, 0x45, 0x5f, 0x46, 0x4f, 0x52, 0x46, 0x45, 0x49, 0x54, 0x10, 0x08, 0x2a, 0x2d, 0x0a, 0x08,
...
var file_api_proto_ipc_omgwords_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_api_proto_ipc_omgwords_proto_goTypes = []interface{}{
	...
	(macondo.ChallengeRule)(0),         // 10: macondo.ChallengeRule
	(macondo.BotRequest_BotCode)(0),    // 11: macondo.BotRequest.BotCode
...
var file_api_proto_ipc_omgwords_proto_depIdxs = []int32{
	...
	10, // 2: liwords.GameRequest.challenge_rule:type_name -> macondo.ChallengeRule
	...
	11, // 5: liwords.GameRequest.bot_type:type_name -> macondo.BotRequest.BotCode
	12, // 6: liwords.GameMetaEvent.timestamp:type_name -> google.protobuf.Timestamp
	4,  // 7: liwords.GameMetaEvent.type:type_name -> liwords.GameMetaEvent.EventType
	13, // 8: liwords.GameHistoryRefresher.history:type_name -> macondo.GameHistory
