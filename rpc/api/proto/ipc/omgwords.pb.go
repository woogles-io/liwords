...
const file_proto_ipc_omgwords_proto_rawDesc = "" +
	...
	"\x05first\x18\t \x01(\bB\x02\x18\x01R\x05first\"\xf3\x04\n" +
	...
	"\x04type\x18\x17 \x01(\x0e2\r.ipc.GameTypeR\x04type\"G\n" +
	...
	"\auntimed\x18\a \x01(\bR\auntimed\";\n" +
	"\rMetaEventData\x12*\n" +
