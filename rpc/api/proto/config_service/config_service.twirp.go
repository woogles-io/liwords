...
func NewConfigServiceProtobufClient(addr string, client HTTPClient, opts ...twirp.ClientOption) ConfigService {
...
func NewConfigServiceJSONClient(addr string, client HTTPClient, opts ...twirp.ClientOption) ConfigService {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
func (s *configServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/config_service.ConfigService/SetGamesEnabled":
...
func (s *configServiceServer) serveSetGamesEnabledJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	func() {
		...
		respContent, err = s.ConfigService.SetGamesEnabled(ctx, reqContent)
	}()
...
func (s *configServiceServer) PathPrefix() string {
	return ConfigServicePathPrefix
}
