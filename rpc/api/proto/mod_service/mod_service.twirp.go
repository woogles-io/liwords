...
type ModService interface {
	...
	DeleteChatMessage(context.Context, *DeleteChatRequest) (*DeleteChatResponse, error)
}
...
func (c *modServiceProtobufClient) DeleteChatMessage(ctx context.Context, in *DeleteChatRequest) (*DeleteChatResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "mod_service")
	ctx = ctxsetters.WithServiceName(ctx, "ModService")
	ctx = ctxsetters.WithMethodName(ctx, "DeleteChatMessage")
	caller := c.callDeleteChatMessage
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *DeleteChatRequest) (*DeleteChatResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*DeleteChatRequest)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*DeleteChatRequest) when calling interceptor")
					}
					return c.callDeleteChatMessage(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*DeleteChatResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*DeleteChatResponse) when calling interceptor")
				}
				return typedResp, err
			}
			return nil, err
...
func (c *modServiceProtobufClient) callDeleteChatMessage(ctx context.Context, in *DeleteChatRequest) (*DeleteChatResponse, error) {
...
func (c *modServiceJSONClient) DeleteChatMessage(ctx context.Context, in *DeleteChatRequest) (*DeleteChatResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "mod_service")
	ctx = ctxsetters.WithServiceName(ctx, "ModService")
	ctx = ctxsetters.WithMethodName(ctx, "DeleteChatMessage")
	caller := c.callDeleteChatMessage
...
func (c *modServiceJSONClient) callDeleteChatMessage(ctx context.Context, in *DeleteChatRequest) (*DeleteChatResponse, error) {
	out := new(DeleteChatResponse)
...
func (s *modServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "DeleteChatMessage":
		s.serveDeleteChatMessage(ctx, resp, req)
		return
	default:
		msg := fmt.Sprintf("no handler for path %q", req.URL.Path)
		s.writeError(ctx, resp, badRouteError(msg, req.Method, req.URL.Path))
...
func (s *modServiceServer) serveDeleteChatMessage(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveDeleteChatMessageJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveDeleteChatMessageProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *modServiceServer) serveDeleteChatMessageJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "DeleteChatMessage")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(DeleteChatRequest)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		s.writeError(ctx, resp, malformedRequestError("the json request could not be decoded"))
		return
	...
	handler := s.ModService.DeleteChatMessage
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *DeleteChatRequest) (*DeleteChatResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*DeleteChatRequest)
					if !ok {
					...
					return s.ModService.DeleteChatMessage(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*DeleteChatResponse)
	...
	// Call service method
	var respContent *DeleteChatResponse
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = handler(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *DeleteChatResponse and nil error while calling DeleteChatMessage. nil responses are not supported"))
		return
	}
...
func (s *modServiceServer) serveDeleteChatMessageProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "DeleteChatMessage")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
