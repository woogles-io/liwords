-- New-user funnel by signup week: of the users who joined in week W, how many
...
WITH new_user_games AS (
    ...
    SELECT
        participants.player,
        DATE_TRUNC('week', participants.player_created_at) AS week_joined,
...
annotators AS (
    SELECT
        DATE_TRUNC('week', au.created_at) AS week_joined,
