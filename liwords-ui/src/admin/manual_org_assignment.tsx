  ...
  wespa: {
    ...
    helpTooltip: (
      <span>
        ...
        , type the name in the search box, and click through to their profile.
        The WESPA ID is the number at the end of the URL (e.g.,{" "}
        <strong>215</strong> from wespa.xerafin.net/player.html?id=215).
      </span>
    ),
  },
  absp: {
