...
import { SeekRequest, SeekState, SoughtGameProcessEvent } from '../gen/api/proto/ipc/omgseeks_pb';
import { GameRequest, GameRules, RatingMode } from '../gen/api/proto/ipc/omgwords_pb';
