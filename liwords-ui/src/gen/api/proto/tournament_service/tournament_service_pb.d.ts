...
export class TournamentPairingRequest extends jspb.Message {
  ...
  getIsForfeit(): boolean;
  setIsForfeit(value: boolean): void;
...
export class StartTournamentRequest extends jspb.Message {
  getId(): string;
  setId(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): StartTournamentRequest.AsObject;
  static toObject(includeInstance: boolean, msg: StartTournamentRequest): StartTournamentRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: StartTournamentRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): StartTournamentRequest;
  static deserializeBinaryFromReader(message: StartTournamentRequest, reader: jspb.BinaryReader): StartTournamentRequest;
}

export namespace StartTournamentRequest {
  export type AsObject = {
    id: string,
  }
}
