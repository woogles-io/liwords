...
goog.exportSymbol('proto.liwords.JoinedRealm', null, global);
 ...
 * @constructor
 */
proto.liwords.JoinedRealm = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.liwords.JoinedRealm, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.liwords.JoinedRealm.displayName = 'proto.liwords.JoinedRealm';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.liwords.JoinedRealm.prototype.toObject = function(opt_includeInstance) {
  return proto.liwords.JoinedRealm.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.liwords.JoinedRealm} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.JoinedRealm.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.liwords.JoinedRealm}
 */
proto.liwords.JoinedRealm.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.liwords.JoinedRealm;
  return proto.liwords.JoinedRealm.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.liwords.JoinedRealm} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.liwords.JoinedRealm}
 */
proto.liwords.JoinedRealm.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.liwords.JoinedRealm.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.liwords.JoinedRealm.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.liwords.JoinedRealm} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.JoinedRealm.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getRealm();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.liwords.JoinedRealm.prototype.getRealm = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.liwords.JoinedRealm} returns this
 */
proto.liwords.JoinedRealm.prototype.setRealm = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
