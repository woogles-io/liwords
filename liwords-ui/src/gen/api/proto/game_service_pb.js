...
goog.exportSymbol('proto.liwords.UnjoinPath', null, global);
/**
 ...
 * @constructor
 */
proto.liwords.UnjoinPath = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.liwords.UnjoinPath, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.liwords.UnjoinPath.displayName = 'proto.liwords.UnjoinPath';
}
 ...
 * @return {!Object}
 */
proto.liwords.UnjoinPath.prototype.toObject = function(opt_includeInstance) {
  return proto.liwords.UnjoinPath.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.liwords.UnjoinPath} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.UnjoinPath.toObject = function(includeInstance, msg) {
  var f, obj = {
    path: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.liwords.UnjoinPath}
 */
proto.liwords.UnjoinPath.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.liwords.UnjoinPath;
  return proto.liwords.UnjoinPath.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.liwords.UnjoinPath} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.liwords.UnjoinPath}
 */
proto.liwords.UnjoinPath.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.liwords.UnjoinPath.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.liwords.UnjoinPath.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.liwords.UnjoinPath} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.UnjoinPath.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPath();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.liwords.UnjoinPath.prototype.getPath = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.liwords.UnjoinPath} returns this
 */
proto.liwords.UnjoinPath.prototype.setPath = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
