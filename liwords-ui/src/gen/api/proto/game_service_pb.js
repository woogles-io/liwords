...
goog.exportSymbol('proto.liwords.GameTurnsRefresher', null, global);
 ...
 * @constructor
 */
proto.liwords.GameTurnsRefresher = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.liwords.GameTurnsRefresher.repeatedFields_, null);
};
goog.inherits(proto.liwords.GameTurnsRefresher, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.liwords.GameTurnsRefresher.displayName = 'proto.liwords.GameTurnsRefresher';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.liwords.GameTurnsRefresher.repeatedFields_ = [1,4];
 ...
 * @return {!Object}
 */
proto.liwords.GameTurnsRefresher.prototype.toObject = function(opt_includeInstance) {
  return proto.liwords.GameTurnsRefresher.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.liwords.GameTurnsRefresher} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.GameTurnsRefresher.toObject = function(includeInstance, msg) {
  var f, obj = {
    turnsList: jspb.Message.toObjectList(msg.getTurnsList(),
    macondo_api_proto_macondo_macondo_pb.GameTurn.toObject, includeInstance),
    playState: jspb.Message.getFieldWithDefault(msg, 2, 0),
    startingTurn: jspb.Message.getFieldWithDefault(msg, 3, 0),
    playersList: jspb.Message.toObjectList(msg.getPlayersList(),
    macondo_api_proto_macondo_macondo_pb.PlayerInfo.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.liwords.GameTurnsRefresher}
 */
proto.liwords.GameTurnsRefresher.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.liwords.GameTurnsRefresher;
  return proto.liwords.GameTurnsRefresher.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.liwords.GameTurnsRefresher} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.liwords.GameTurnsRefresher}
 */
proto.liwords.GameTurnsRefresher.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new macondo_api_proto_macondo_macondo_pb.GameTurn;
      reader.readMessage(value,macondo_api_proto_macondo_macondo_pb.GameTurn.deserializeBinaryFromReader);
      msg.addTurns(value);
      break;
    case 2:
      var value = /** @type {!proto.macondo.PlayState} */ (reader.readEnum());
    ...
    case 3:
      var value = /** @type {number} */ (reader.readInt32());
      msg.setStartingTurn(value);
      break;
    case 4:
      var value = new macondo_api_proto_macondo_macondo_pb.PlayerInfo;
      reader.readMessage(value,macondo_api_proto_macondo_macondo_pb.PlayerInfo.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.liwords.GameTurnsRefresher.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.liwords.GameTurnsRefresher.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.liwords.GameTurnsRefresher} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.GameTurnsRefresher.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      macondo_api_proto_macondo_macondo_pb.GameTurn.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
      macondo_api_proto_macondo_macondo_pb.PlayerInfo.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated macondo.GameTurn turns = 1;
 * @return {!Array<!proto.macondo.GameTurn>}
 */
proto.liwords.GameTurnsRefresher.prototype.getTurnsList = function() {
  return /** @type{!Array<!proto.macondo.GameTurn>} */ (
    jspb.Message.getRepeatedWrapperField(this, macondo_api_proto_macondo_macondo_pb.GameTurn, 1));
};


/**
 * @param {!Array<!proto.macondo.GameTurn>} value
 * @return {!proto.liwords.GameTurnsRefresher} returns this
*/
proto.liwords.GameTurnsRefresher.prototype.setTurnsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 */
proto.liwords.GameTurnsRefresher.prototype.addTurns = function(opt_value, opt_index) {
 ...
 * @return {!proto.liwords.GameTurnsRefresher} returns this
 */
proto.liwords.GameTurnsRefresher.prototype.clearTurnsList = function() {
  return this.setTurnsList([]);
};


/**
 * optional macondo.PlayState play_state = 2;
 * @return {!proto.macondo.PlayState}
 */
proto.liwords.GameTurnsRefresher.prototype.getPlayState = function() {
  return /** @type {!proto.macondo.PlayState} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.liwords.GameTurnsRefresher} returns this
 */
proto.liwords.GameTurnsRefresher.prototype.setPlayState = function(value) {
  return jspb.Message.setProto3EnumField(this, 2, value);
};


/**
 * optional int32 starting_turn = 3;
 * @return {number}
 */
proto.liwords.GameTurnsRefresher.prototype.getStartingTurn = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.liwords.GameTurnsRefresher} returns this
 */
proto.liwords.GameTurnsRefresher.prototype.setStartingTurn = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};


/**
 * repeated macondo.PlayerInfo players = 4;
 * @return {!Array<!proto.macondo.PlayerInfo>}
 */
proto.liwords.GameTurnsRefresher.prototype.getPlayersList = function() {
  return /** @type{!Array<!proto.macondo.PlayerInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, macondo_api_proto_macondo_macondo_pb.PlayerInfo, 4));
};
 ...
 * @return {!proto.liwords.GameTurnsRefresher} returns this
*/
proto.liwords.GameTurnsRefresher.prototype.setPlayersList = function(value) {
 ...
 */
proto.liwords.GameTurnsRefresher.prototype.addPlayers = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.macondo.PlayerInfo, opt_index);
};
 ...
 * @return {!proto.liwords.GameTurnsRefresher} returns this
 */
proto.liwords.GameTurnsRefresher.prototype.clearPlayersList = function() {
