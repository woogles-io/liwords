...
export type GameRequest = Message<"ipc.GameRequest"> & {
   ...
   *
   * Max hours allowed per move (e.g., 60 for regular, 8 for league)
   *
   * @generated from field: int32 per_move_time_hours = 13;
   */
  perMoveTimeHours: number;

  /**
   * Total time bank in hours (e.g., 0 for regular, 96 for league)
   *
   * @generated from field: int32 time_bank_hours = 14;
   */
