 ...
 */
export const UserPresence = /*@__PURE__*/ proto3.makeMessageType(
  "ipc.UserPresence",
  () => [
 ...
 */
export const UserPresences = /*@__PURE__*/ proto3.makeMessageType(
  "ipc.UserPresences",
  () => [
 ...
 */
export const PresenceEntry = /*@__PURE__*/ proto3.makeMessageType(
  "ipc.PresenceEntry",
  () => [
    { no: 1, name: "username", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "user_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
