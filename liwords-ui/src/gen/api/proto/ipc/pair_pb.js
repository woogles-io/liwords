...
export const PairError = /*@__PURE__*/ proto3.makeEnum(
  ...
  [
    ...
    {no: 15, name: "MORE_CLASSES_THAN_PLAYERS"},
    {no: 16, name: "INVALID_CLASS"},
    {no: 17, name: "MISORDERED_CLASS"},
    {no: 18, name: "INVALID_CLASS_PRIZES_COUNT"},
    {no: 19, name: "INVALID_CLASS_PRIZE"},
    {no: 20, name: "INVALID_GIBSON_SPREAD_COUNT"},
    {no: 21, name: "INVALID_GIBSON_SPREAD"},
    {no: 22, name: "INVALID_CONTROL_LOSS_THRESHOLD"},
    {no: 23, name: "INVALID_HOPEFULNESS_THRESHOLD"},
