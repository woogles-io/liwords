...
export const PairError = /*@__PURE__*/ proto3.makeEnum(
  ...
  [
    ...
    {no: 18, name: "INVALID_GIBSON_SPREAD_COUNT"},
    {no: 19, name: "INVALID_GIBSON_SPREAD"},
    {no: 20, name: "INVALID_CONTROL_LOSS_THRESHOLD"},
    {no: 21, name: "INVALID_HOPEFULNESS_THRESHOLD"},
    {no: 22, name: "INVALID_DIVISION_SIMS"},
    {no: 23, name: "INVALID_CONTROL_LOSS_SIMS"},
    {no: 24, name: "INVALID_PLACE_PRIZES"},
    {no: 25, name: "INVALID_REMOVED_PLAYER"},
    {no: 26, name: "INVALID_VALID_PLAYER_COUNT"},
    {no: 27, name: "MIN_WEIGHT_MATCHING"},
    {no: 28, name: "INVALID_PAIRINGS_LENGTH"},
    {no: 29, name: "OVERCONSTRAINED"},
    {no: 30, name: "REQUEST_TO_JSON_FAILED"},
  ],
);
