...
export const PairError = /*@__PURE__*/ proto3.makeEnum(
  ...
  [
    ...
    {no: 9, name: "UNPAIRED_PLAYER"},
    {no: 10, name: "INVALID_PAIRING"},
    {no: 11, name: "MORE_RESULTS_THAN_ROUNDS"},
    {no: 12, name: "MORE_RESULTS_THAN_PAIRINGS"},
    {no: 13, name: "INVALID_ROUND_RESULTS_COUNT"},
    {no: 14, name: "MORE_CLASSES_THAN_PLAYERS"},
    {no: 15, name: "INVALID_CLASS"},
    {no: 16, name: "MISORDERED_CLASS"},
    {no: 17, name: "INVALID_CLASS_PRIZES_COUNT"},
    {no: 18, name: "INVALID_CLASS_PRIZE"},
    {no: 19, name: "INVALID_GIBSON_SPREAD_COUNT"},
    {no: 20, name: "INVALID_GIBSON_SPREAD"},
    {no: 21, name: "INVALID_CONTROL_LOSS_THRESHOLD"},
    {no: 22, name: "INVALID_HOPEFULNESS_THRESHOLD"},
    {no: 23, name: "INVALID_DIVISION_SIMS"},
    {no: 24, name: "INVALID_CONTROL_LOSS_SIMS"},
    {no: 25, name: "INVALID_PLACE_PRIZES"},
    {no: 26, name: "REQUEST_TO_JSON_FAILED"},
  ],
);
...
export const PairRequest = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "division_pairings", kind: "message", T: RoundPairings, repeated: true },
    { no: 4, name: "division_results", kind: "message", T: RoundResults, repeated: true },
    { no: 5, name: "classes", kind: "scalar", T: 5 /* ScalarType.INT32 */, repeated: true },
