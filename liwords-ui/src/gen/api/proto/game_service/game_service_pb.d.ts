...
import type {ChallengeRule, GameHistory} from "../macondo/macondo_pb.js";
import type {GameDocument, GameRules} from "../ipc/omgwords_pb.js";
...
export declare class CreateBroadcastGameRequest extends Message<CreateBroadcastGameRequest> {
  ...
  /**
   * @generated from field: macondo.ChallengeRule challenge_rule = 4;
   */
