...
goog.exportSymbol('proto.liwords.DivisionRoundControlsResponse', null, global);
...
goog.exportSymbol('proto.liwords.PlayerAddedOrRemovedResponse', null, global);
...
goog.exportSymbol('proto.liwords.RoundPairings', null, global);
...
goog.exportSymbol('proto.liwords.StartRoundResponse', null, global);
 ...
 * @constructor
 */
proto.liwords.RoundPairings = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.liwords.RoundPairings.repeatedFields_, null);
};
goog.inherits(proto.liwords.RoundPairings, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.liwords.RoundPairings.displayName = 'proto.liwords.RoundPairings';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.liwords.PlayerAddedOrRemovedResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.liwords.PlayerAddedOrRemovedResponse.repeatedFields_, null);
};
goog.inherits(proto.liwords.PlayerAddedOrRemovedResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.liwords.PlayerAddedOrRemovedResponse.displayName = 'proto.liwords.PlayerAddedOrRemovedResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.liwords.StartRoundResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.liwords.StartRoundResponse.repeatedFields_, null);
};
goog.inherits(proto.liwords.StartRoundResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.liwords.StartRoundResponse.displayName = 'proto.liwords.StartRoundResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.liwords.DivisionRoundControlsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.liwords.DivisionRoundControlsResponse.repeatedFields_, null);
};
goog.inherits(proto.liwords.DivisionRoundControlsResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.liwords.DivisionRoundControlsResponse.displayName = 'proto.liwords.DivisionRoundControlsResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.liwords.Pairing.repeatedFields_ = [1,2,3,4];
 ...
 * @const
 */
proto.liwords.RoundPairings.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.liwords.RoundPairings.prototype.toObject = function(opt_includeInstance) {
  return proto.liwords.RoundPairings.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.liwords.RoundPairings} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.RoundPairings.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.liwords.RoundPairings}
 */
proto.liwords.RoundPairings.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.liwords.RoundPairings;
  return proto.liwords.RoundPairings.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.liwords.RoundPairings} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.liwords.RoundPairings}
 */
proto.liwords.RoundPairings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.liwords.RoundPairings.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.liwords.RoundPairings.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.liwords.RoundPairings} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.RoundPairings.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getRound();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.liwords.RoundPairings.prototype.getRound = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.liwords.RoundPairings} returns this
 */
proto.liwords.RoundPairings.prototype.setRound = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};


/**
 * repeated Pairing pairings = 2;
 * @return {!Array<!proto.liwords.Pairing>}
 */
proto.liwords.RoundPairings.prototype.getPairingsList = function() {
  return /** @type{!Array<!proto.liwords.Pairing>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.liwords.Pairing, 2));
};
 ...
 * @return {!proto.liwords.RoundPairings} returns this
*/
proto.liwords.RoundPairings.prototype.setPairingsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};
 ...
 * @return {!proto.liwords.Pairing}
 */
proto.liwords.RoundPairings.prototype.addPairings = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.liwords.Pairing, opt_index);
};
 ...
 * @return {!proto.liwords.RoundPairings} returns this
 */
proto.liwords.RoundPairings.prototype.clearPairingsList = function() {
...
proto.liwords.DivisionPairingsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.liwords.RoundPairings.toObject, includeInstance)
  };
...
proto.liwords.DivisionPairingsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.liwords.RoundPairings;
      reader.readMessage(value,proto.liwords.RoundPairings.deserializeBinaryFromReader);
...
proto.liwords.DivisionPairingsResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.liwords.RoundPairings.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.liwords.RoundPairings>}
 */
proto.liwords.DivisionPairingsResponse.prototype.getDivisionPairingsList = function() {
  return /** @type{!Array<!proto.liwords.RoundPairings>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.liwords.RoundPairings, 3));
};


/**
 * @param {!Array<!proto.liwords.RoundPairings>} value
 * @return {!proto.liwords.DivisionPairingsResponse} returns this
*/
...
/**
 * @param {!proto.liwords.RoundPairings=} opt_value
 * @param {number=} opt_index
 * @return {!proto.liwords.RoundPairings}
 */
proto.liwords.DivisionPairingsResponse.prototype.addDivisionPairings = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.liwords.RoundPairings, opt_index);
};
 ...
 * @const
 */
proto.liwords.PlayerAddedOrRemovedResponse.repeatedFields_ = [5];
 ...
 * @return {!Object}
 */
proto.liwords.PlayerAddedOrRemovedResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.liwords.PlayerAddedOrRemovedResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.liwords.PlayerAddedOrRemovedResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.PlayerAddedOrRemovedResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    division: jspb.Message.getFieldWithDefault(msg, 2, ""),
    added: jspb.Message.getBooleanFieldWithDefault(msg, 3, false),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.liwords.PlayerAddedOrRemovedResponse}
 */
proto.liwords.PlayerAddedOrRemovedResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.liwords.PlayerAddedOrRemovedResponse;
  return proto.liwords.PlayerAddedOrRemovedResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.liwords.PlayerAddedOrRemovedResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.liwords.PlayerAddedOrRemovedResponse}
 */
proto.liwords.PlayerAddedOrRemovedResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.liwords.PlayerAddedOrRemovedResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.liwords.PlayerAddedOrRemovedResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.liwords.PlayerAddedOrRemovedResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.PlayerAddedOrRemovedResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.liwords.PlayerAddedOrRemovedResponse.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.liwords.PlayerAddedOrRemovedResponse.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.liwords.PlayerAddedOrRemovedResponse.prototype.getDivision = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.liwords.PlayerAddedOrRemovedResponse} returns this
 */
proto.liwords.PlayerAddedOrRemovedResponse.prototype.setDivision = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.liwords.PlayerAddedOrRemovedResponse.prototype.getAdded = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 3, false));
};
 ...
 * @return {!proto.liwords.PlayerAddedOrRemovedResponse} returns this
 */
proto.liwords.PlayerAddedOrRemovedResponse.prototype.setAdded = function(value) {
  return jspb.Message.setProto3BooleanField(this, 3, value);
};


/**
 * optional TournamentPersons players = 4;
 * @return {?proto.liwords.TournamentPersons}
 */
proto.liwords.PlayerAddedOrRemovedResponse.prototype.getPlayers = function() {
  return /** @type{?proto.liwords.TournamentPersons} */ (
    jspb.Message.getWrapperField(this, proto.liwords.TournamentPersons, 4));
};
 ...
 * @return {!proto.liwords.PlayerAddedOrRemovedResponse} returns this
*/
proto.liwords.PlayerAddedOrRemovedResponse.prototype.setPlayers = function(value) {
 ...
 * @return {!proto.liwords.PlayerAddedOrRemovedResponse} returns this
 */
proto.liwords.PlayerAddedOrRemovedResponse.prototype.clearPlayers = function() {
 ...
 * @return {boolean}
 */
proto.liwords.PlayerAddedOrRemovedResponse.prototype.hasPlayers = function() {
  return jspb.Message.getField(this, 4) != null;
};


/**
 * repeated RoundPairings division_pairings = 5;
 * @return {!Array<!proto.liwords.RoundPairings>}
 */
proto.liwords.PlayerAddedOrRemovedResponse.prototype.getDivisionPairingsList = function() {
  return /** @type{!Array<!proto.liwords.RoundPairings>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.liwords.RoundPairings, 5));
};
 ...
 * @return {!proto.liwords.PlayerAddedOrRemovedResponse} returns this
*/
proto.liwords.PlayerAddedOrRemovedResponse.prototype.setDivisionPairingsList = function(value) {
 ...
 * @return {!proto.liwords.RoundPairings}
 */
proto.liwords.PlayerAddedOrRemovedResponse.prototype.addDivisionPairings = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.liwords.RoundPairings, opt_index);
};
 ...
 * @const
 */
proto.liwords.StartRoundResponse.repeatedFields_ = [2,3];
 ...
 * @return {!Object}
 */
proto.liwords.StartRoundResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.liwords.StartRoundResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.liwords.StartRoundResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.StartRoundResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    divisionIdsList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? undefined : f,
    roundsList: (f = jspb.Message.getRepeatedField(msg, 3)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.liwords.StartRoundResponse}
 */
proto.liwords.StartRoundResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.liwords.StartRoundResponse;
  return proto.liwords.StartRoundResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.liwords.StartRoundResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.liwords.StartRoundResponse}
 */
proto.liwords.StartRoundResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      var value = /** @type {string} */ (reader.readString());
      msg.addDivisionIds(value);
      break;
    case 3:
      var values = /** @type {!Array<number>} */ (reader.isDelimited() ? reader.readPackedInt32() : [reader.readInt32()]);
      for (var i = 0; i < values.length; i++) {
        msg.addRounds(values[i]);
      }
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.liwords.StartRoundResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.liwords.StartRoundResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.liwords.StartRoundResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.StartRoundResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.liwords.StartRoundResponse.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.liwords.StartRoundResponse} returns this
 */
proto.liwords.StartRoundResponse.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * repeated string division_ids = 2;
 * @return {!Array<string>}
 */
proto.liwords.StartRoundResponse.prototype.getDivisionIdsList = function() {
 ...
 * @return {!proto.liwords.StartRoundResponse} returns this
 */
proto.liwords.StartRoundResponse.prototype.setDivisionIdsList = function(value) {
  return jspb.Message.setField(this, 2, value || []);
};
 ...
 * @return {!proto.liwords.StartRoundResponse} returns this
 */
proto.liwords.StartRoundResponse.prototype.addDivisionIds = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 2, value, opt_index);
};
 ...
 * @return {!proto.liwords.StartRoundResponse} returns this
 */
proto.liwords.StartRoundResponse.prototype.clearDivisionIdsList = function() {
  return this.setDivisionIdsList([]);
};


/**
 * repeated int32 rounds = 3;
 * @return {!Array<number>}
 */
proto.liwords.StartRoundResponse.prototype.getRoundsList = function() {
 ...
 * @return {!proto.liwords.StartRoundResponse} returns this
 */
proto.liwords.StartRoundResponse.prototype.setRoundsList = function(value) {
  return jspb.Message.setField(this, 3, value || []);
};
 ...
 * @return {!proto.liwords.StartRoundResponse} returns this
 */
proto.liwords.StartRoundResponse.prototype.addRounds = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 3, value, opt_index);
};
 ...
 * @return {!proto.liwords.StartRoundResponse} returns this
 */
proto.liwords.StartRoundResponse.prototype.clearRoundsList = function() {
 ...
 * @const
 */
proto.liwords.DivisionRoundControlsResponse.repeatedFields_ = [3];
 ...
 * @return {!Object}
 */
proto.liwords.DivisionRoundControlsResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.liwords.DivisionRoundControlsResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.liwords.DivisionRoundControlsResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.DivisionRoundControlsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    division: jspb.Message.getFieldWithDefault(msg, 2, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.liwords.DivisionRoundControlsResponse}
 */
proto.liwords.DivisionRoundControlsResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.liwords.DivisionRoundControlsResponse;
  return proto.liwords.DivisionRoundControlsResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.liwords.DivisionRoundControlsResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.liwords.DivisionRoundControlsResponse}
 */
proto.liwords.DivisionRoundControlsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.liwords.DivisionRoundControlsResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.liwords.DivisionRoundControlsResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.liwords.DivisionRoundControlsResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.DivisionRoundControlsResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.liwords.DivisionRoundControlsResponse.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.liwords.DivisionRoundControlsResponse} returns this
 */
proto.liwords.DivisionRoundControlsResponse.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.liwords.DivisionRoundControlsResponse.prototype.getDivision = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.liwords.DivisionRoundControlsResponse} returns this
 */
proto.liwords.DivisionRoundControlsResponse.prototype.setDivision = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 */
proto.liwords.DivisionRoundControlsResponse.prototype.getRoundControlsList = function() {
 ...
 * @return {!proto.liwords.DivisionRoundControlsResponse} returns this
*/
proto.liwords.DivisionRoundControlsResponse.prototype.setRoundControlsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 3, value);
};
 ...
 * @return {!proto.liwords.RoundControl}
 */
proto.liwords.DivisionRoundControlsResponse.prototype.addRoundControls = function(opt_value, opt_index) {
 ...
 * @return {!proto.liwords.DivisionRoundControlsResponse} returns this
 */
proto.liwords.DivisionRoundControlsResponse.prototype.clearRoundControlsList = function() {
 ...
 * @const
 */
proto.liwords.TournamentDivisionDataResponse.repeatedFields_ = [6];
...
proto.liwords.TournamentDivisionDataResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(4, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.liwords.Pairing.serializeBinaryToWriter);
  }
...
/**
 * map<string, Pairing> pairing_map = 4;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
...
/**
 * optional DivisionControls controls = 5;
 * @return {?proto.liwords.DivisionControls}
 */
proto.liwords.TournamentDivisionDataResponse.prototype.getControls = function() {
  return /** @type{?proto.liwords.DivisionControls} */ (
    jspb.Message.getWrapperField(this, proto.liwords.DivisionControls, 5));
};
...
/**
 * repeated RoundControl round_controls = 6;
 * @return {!Array<!proto.liwords.RoundControl>}
 */
proto.liwords.TournamentDivisionDataResponse.prototype.getRoundControlsList = function() {
  return /** @type{!Array<!proto.liwords.RoundControl>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.liwords.RoundControl, 6));
};
...
proto.liwords.TournamentDivisionDataResponse.prototype.addRoundControls = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 6, opt_value, proto.liwords.RoundControl, opt_index);
};
