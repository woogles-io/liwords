...
goog.exportSymbol('proto.liwords.TournamentControls', null, global);
...
goog.exportSymbol('proto.liwords.TournamentMatchRequest', null, global);
goog.exportSymbol('proto.liwords.TournamentMatchRequests', null, global);
 ...
 * @constructor
 */
proto.liwords.TournamentMatchRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.liwords.TournamentMatchRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.liwords.TournamentMatchRequest.displayName = 'proto.liwords.TournamentMatchRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.liwords.TournamentMatchRequests = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.liwords.TournamentMatchRequests.repeatedFields_, null);
};
goog.inherits(proto.liwords.TournamentMatchRequests, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.liwords.TournamentMatchRequests.displayName = 'proto.liwords.TournamentMatchRequests';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.liwords.TournamentControls = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.liwords.TournamentControls.repeatedFields_, null);
};
goog.inherits(proto.liwords.TournamentControls, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.liwords.TournamentControls.displayName = 'proto.liwords.TournamentControls';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.liwords.PlayerRoundInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.liwords.PlayerRoundInfo.repeatedFields_, null);
};
goog.inherits(proto.liwords.PlayerRoundInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.liwords.PlayerRoundInfo.displayName = 'proto.liwords.PlayerRoundInfo';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.liwords.ClassicDivision = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.liwords.ClassicDivision.repeatedFields_, null);
};
goog.inherits(proto.liwords.ClassicDivision, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.liwords.ClassicDivision.displayName = 'proto.liwords.ClassicDivision';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.liwords.TournamentDataResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.liwords.TournamentDataResponse.repeatedFields_, null);
};
 ...
 * @return {!Object}
 */
proto.liwords.TournamentMatchRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.liwords.TournamentMatchRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.liwords.TournamentMatchRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.TournamentMatchRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    gameRequest: (f = msg.getGameRequest()) && proto.liwords.GameRequest.toObject(includeInstance, f),
    player1: (f = msg.getPlayer1()) && proto.liwords.MatchUser.toObject(includeInstance, f),
    player2: (f = msg.getPlayer2()) && proto.liwords.MatchUser.toObject(includeInstance, f),
    forceFirst: jspb.Message.getBooleanFieldWithDefault(msg, 4, false),
    tournamentId: jspb.Message.getFieldWithDefault(msg, 5, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.liwords.TournamentMatchRequest}
 */
proto.liwords.TournamentMatchRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.liwords.TournamentMatchRequest;
  return proto.liwords.TournamentMatchRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.liwords.TournamentMatchRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.liwords.TournamentMatchRequest}
 */
proto.liwords.TournamentMatchRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.liwords.TournamentMatchRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.liwords.TournamentMatchRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.liwords.TournamentMatchRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.TournamentMatchRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getGameRequest();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.liwords.GameRequest}
 */
proto.liwords.TournamentMatchRequest.prototype.getGameRequest = function() {
  return /** @type{?proto.liwords.GameRequest} */ (
    jspb.Message.getWrapperField(this, proto.liwords.GameRequest, 1));
};
...
/**
 * @param {?proto.liwords.GameRequest|undefined} value
 * @return {!proto.liwords.TournamentMatchRequest} returns this
*/
proto.liwords.TournamentMatchRequest.prototype.setGameRequest = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.liwords.TournamentMatchRequest} returns this
 */
proto.liwords.TournamentMatchRequest.prototype.clearGameRequest = function() {
  return this.setGameRequest(undefined);
};
 ...
 * @return {boolean}
 */
proto.liwords.TournamentMatchRequest.prototype.hasGameRequest = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional MatchUser player1 = 2;
 * @return {?proto.liwords.MatchUser}
 */
proto.liwords.TournamentMatchRequest.prototype.getPlayer1 = function() {
  return /** @type{?proto.liwords.MatchUser} */ (
    jspb.Message.getWrapperField(this, proto.liwords.MatchUser, 2));
};
 ...
 * @return {!proto.liwords.TournamentMatchRequest} returns this
*/
proto.liwords.TournamentMatchRequest.prototype.setPlayer1 = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.liwords.TournamentMatchRequest} returns this
 */
proto.liwords.TournamentMatchRequest.prototype.clearPlayer1 = function() {
 ...
 * @return {boolean}
 */
proto.liwords.TournamentMatchRequest.prototype.hasPlayer1 = function() {
  return jspb.Message.getField(this, 2) != null;
};


/**
 * optional MatchUser player2 = 3;
 * @return {?proto.liwords.MatchUser}
 */
proto.liwords.TournamentMatchRequest.prototype.getPlayer2 = function() {
  return /** @type{?proto.liwords.MatchUser} */ (
    jspb.Message.getWrapperField(this, proto.liwords.MatchUser, 3));
};
 ...
 * @return {!proto.liwords.TournamentMatchRequest} returns this
*/
proto.liwords.TournamentMatchRequest.prototype.setPlayer2 = function(value) {
  return jspb.Message.setWrapperField(this, 3, value);
};
 ...
 * @return {!proto.liwords.TournamentMatchRequest} returns this
 */
proto.liwords.TournamentMatchRequest.prototype.clearPlayer2 = function() {
 ...
 * @return {boolean}
 */
proto.liwords.TournamentMatchRequest.prototype.hasPlayer2 = function() {
  return jspb.Message.getField(this, 3) != null;
};


/**
 * optional bool force_first = 4;
 * @return {boolean}
 */
proto.liwords.TournamentMatchRequest.prototype.getForceFirst = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 4, false));
};
 ...
 * @return {!proto.liwords.TournamentMatchRequest} returns this
 */
proto.liwords.TournamentMatchRequest.prototype.setForceFirst = function(value) {
  return jspb.Message.setProto3BooleanField(this, 4, value);
};


/**
 * optional string tournament_id = 5;
 * @return {string}
 */
proto.liwords.TournamentMatchRequest.prototype.getTournamentId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};
 ...
 * @return {!proto.liwords.TournamentMatchRequest} returns this
 */
proto.liwords.TournamentMatchRequest.prototype.setTournamentId = function(value) {
  return jspb.Message.setProto3StringField(this, 5, value);
};
 ...
 * @const
 */
proto.liwords.TournamentMatchRequests.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.liwords.TournamentMatchRequests.prototype.toObject = function(opt_includeInstance) {
  return proto.liwords.TournamentMatchRequests.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.liwords.TournamentMatchRequests} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.TournamentMatchRequests.toObject = function(includeInstance, msg) {
  var f, obj = {
    requestsList: jspb.Message.toObjectList(msg.getRequestsList(),
    proto.liwords.TournamentMatchRequest.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.liwords.TournamentMatchRequests}
 */
proto.liwords.TournamentMatchRequests.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.liwords.TournamentMatchRequests;
  return proto.liwords.TournamentMatchRequests.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.liwords.TournamentMatchRequests} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.liwords.TournamentMatchRequests}
 */
proto.liwords.TournamentMatchRequests.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.liwords.TournamentMatchRequest;
      reader.readMessage(value,proto.liwords.TournamentMatchRequest.deserializeBinaryFromReader);
      msg.addRequests(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.liwords.TournamentMatchRequests.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.liwords.TournamentMatchRequests.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.liwords.TournamentMatchRequests} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.TournamentMatchRequests.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getRequestsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.liwords.TournamentMatchRequest.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated TournamentMatchRequest requests = 1;
 * @return {!Array<!proto.liwords.TournamentMatchRequest>}
 */
proto.liwords.TournamentMatchRequests.prototype.getRequestsList = function() {
  return /** @type{!Array<!proto.liwords.TournamentMatchRequest>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.liwords.TournamentMatchRequest, 1));
};


/**
 * @param {!Array<!proto.liwords.TournamentMatchRequest>} value
 * @return {!proto.liwords.TournamentMatchRequests} returns this
*/
proto.liwords.TournamentMatchRequests.prototype.setRequestsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.liwords.TournamentMatchRequest=} opt_value
 * @param {number=} opt_index
 * @return {!proto.liwords.TournamentMatchRequest}
 */
proto.liwords.TournamentMatchRequests.prototype.addRequests = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.liwords.TournamentMatchRequest, opt_index);
};
 ...
 * @return {!proto.liwords.TournamentMatchRequests} returns this
 */
proto.liwords.TournamentMatchRequests.prototype.clearRequestsList = function() {
  return this.setRequestsList([]);
};
 ...
 * @const
 */
proto.liwords.TournamentControls.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.liwords.TournamentControls.prototype.toObject = function(opt_includeInstance) {
  return proto.liwords.TournamentControls.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.liwords.TournamentControls} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.TournamentControls.toObject = function(includeInstance, msg) {
  var f, obj = {
    gameRequest: (f = msg.getGameRequest()) && proto.liwords.GameRequest.toObject(includeInstance, f),
 ...
 */
proto.liwords.TournamentControls.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.liwords.TournamentControls;
  return proto.liwords.TournamentControls.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.liwords.TournamentControls} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.liwords.TournamentControls}
 */
proto.liwords.TournamentControls.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.liwords.TournamentControls.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.liwords.TournamentControls.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.liwords.TournamentControls} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.TournamentControls.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getGameRequest();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.liwords.GameRequest}
 */
proto.liwords.TournamentControls.prototype.getGameRequest = function() {
  return /** @type{?proto.liwords.GameRequest} */ (
    jspb.Message.getWrapperField(this, proto.liwords.GameRequest, 1));
};
...
/**
 * @param {?proto.liwords.GameRequest|undefined} value
 * @return {!proto.liwords.TournamentControls} returns this
*/
proto.liwords.TournamentControls.prototype.setGameRequest = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.liwords.TournamentControls} returns this
 */
proto.liwords.TournamentControls.prototype.clearGameRequest = function() {
  return this.setGameRequest(undefined);
};
 ...
 * @return {boolean}
 */
proto.liwords.TournamentControls.prototype.hasGameRequest = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * repeated RoundControl round_controls = 2;
 * @return {!Array<!proto.liwords.RoundControl>}
 */
proto.liwords.TournamentControls.prototype.getRoundControlsList = function() {
  return /** @type{!Array<!proto.liwords.RoundControl>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.liwords.RoundControl, 2));
};
 ...
 * @return {!proto.liwords.TournamentControls} returns this
*/
proto.liwords.TournamentControls.prototype.setRoundControlsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};
 ...
 * @return {!proto.liwords.RoundControl}
 */
proto.liwords.TournamentControls.prototype.addRoundControls = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.liwords.RoundControl, opt_index);
};
 ...
 * @return {!proto.liwords.TournamentControls} returns this
 */
proto.liwords.TournamentControls.prototype.clearRoundControlsList = function() {
 ...
 * @return {number}
 */
proto.liwords.TournamentControls.prototype.getType = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.liwords.TournamentControls} returns this
 */
proto.liwords.TournamentControls.prototype.setType = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @return {!Object}
 */
proto.liwords.PlayerRoundInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.liwords.PlayerRoundInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.liwords.PlayerRoundInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.PlayerRoundInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.liwords.PlayerRoundInfo}
 */
proto.liwords.PlayerRoundInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.liwords.PlayerRoundInfo;
  return proto.liwords.PlayerRoundInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.liwords.PlayerRoundInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.liwords.PlayerRoundInfo}
 */
proto.liwords.PlayerRoundInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.liwords.PlayerRoundInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.liwords.PlayerRoundInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.liwords.PlayerRoundInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.PlayerRoundInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPlayersList();
  if (f.length > 0) {
 ...
 * @return {!Array<string>}
 */
proto.liwords.PlayerRoundInfo.prototype.getPlayersList = function() {
 ...
 */
proto.liwords.PlayerRoundInfo.prototype.setPlayersList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};
 ...
 * @return {!proto.liwords.PlayerRoundInfo} returns this
 */
proto.liwords.PlayerRoundInfo.prototype.addPlayers = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.liwords.PlayerRoundInfo} returns this
 */
proto.liwords.PlayerRoundInfo.prototype.clearPlayersList = function() {
  return this.setPlayersList([]);
};


/**
 * repeated TournamentGame games = 2;
 * @return {!Array<!proto.liwords.TournamentGame>}
 */
proto.liwords.PlayerRoundInfo.prototype.getGamesList = function() {
  return /** @type{!Array<!proto.liwords.TournamentGame>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.liwords.TournamentGame, 2));
};
 ...
 * @return {!proto.liwords.PlayerRoundInfo} returns this
*/
proto.liwords.PlayerRoundInfo.prototype.setGamesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};
 ...
 * @return {!proto.liwords.TournamentGame}
 */
proto.liwords.PlayerRoundInfo.prototype.addGames = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.liwords.TournamentGame, opt_index);
};
 ...
 * @return {!proto.liwords.PlayerRoundInfo} returns this
 */
proto.liwords.PlayerRoundInfo.prototype.clearGamesList = function() {
  return this.setGamesList([]);
};


/**
 * repeated TournamentGameResult outcomes = 3;
 * @return {!Array<!proto.liwords.TournamentGameResult>}
 */
proto.liwords.PlayerRoundInfo.prototype.getOutcomesList = function() {
  return /** @type {!Array<!proto.liwords.TournamentGameResult>} */ (jspb.Message.getRepeatedField(this, 3));
};
 ...
 * @return {!proto.liwords.PlayerRoundInfo} returns this
 */
proto.liwords.PlayerRoundInfo.prototype.setOutcomesList = function(value) {
 ...
 * @return {!proto.liwords.PlayerRoundInfo} returns this
 */
proto.liwords.PlayerRoundInfo.prototype.addOutcomes = function(value, opt_index) {
 ...
 * @const
 */
proto.liwords.ClassicDivision.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.liwords.ClassicDivision.prototype.toObject = function(opt_includeInstance) {
  return proto.liwords.ClassicDivision.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.liwords.ClassicDivision} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.ClassicDivision.toObject = function(includeInstance, msg) {
  var f, obj = {
    matrixList: jspb.Message.toObjectList(msg.getMatrixList(),
    proto.liwords.PlayerRoundInfo.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.liwords.ClassicDivision}
 */
proto.liwords.ClassicDivision.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.liwords.ClassicDivision;
  return proto.liwords.ClassicDivision.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.liwords.ClassicDivision} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.liwords.ClassicDivision}
 */
proto.liwords.ClassicDivision.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.liwords.PlayerRoundInfo;
      reader.readMessage(value,proto.liwords.PlayerRoundInfo.deserializeBinaryFromReader);
      msg.addMatrix(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.liwords.ClassicDivision.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.liwords.ClassicDivision.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.liwords.ClassicDivision} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.liwords.ClassicDivision.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.liwords.PlayerRoundInfo.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated PlayerRoundInfo matrix = 1;
 * @return {!Array<!proto.liwords.PlayerRoundInfo>}
 */
proto.liwords.ClassicDivision.prototype.getMatrixList = function() {
  return /** @type{!Array<!proto.liwords.PlayerRoundInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.liwords.PlayerRoundInfo, 1));
};


/**
 * @param {!Array<!proto.liwords.PlayerRoundInfo>} value
 * @return {!proto.liwords.ClassicDivision} returns this
*/
proto.liwords.ClassicDivision.prototype.setMatrixList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.liwords.PlayerRoundInfo=} opt_value
 * @param {number=} opt_index
 * @return {!proto.liwords.PlayerRoundInfo}
 */
proto.liwords.ClassicDivision.prototype.addMatrix = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.liwords.PlayerRoundInfo, opt_index);
};
 ...
 * @return {!proto.liwords.ClassicDivision} returns this
 */
proto.liwords.ClassicDivision.prototype.clearMatrixList = function() {
 ...
 * @const
 */
proto.liwords.TournamentDivisionDataResponse.repeatedFields_ = [3];
...
proto.liwords.TournamentDivisionDataResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    division: (f = msg.getDivision()) && proto.liwords.ClassicDivision.toObject(includeInstance, f),
    currentRound: jspb.Message.getFieldWithDefault(msg, 6, 0),
    roundIsOver: jspb.Message.getBooleanFieldWithDefault(msg, 7, false),
    divisionIsOver: jspb.Message.getBooleanFieldWithDefault(msg, 8, false)
  };
...
proto.liwords.TournamentDivisionDataResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.liwords.ClassicDivision;
      reader.readMessage(value,proto.liwords.ClassicDivision.deserializeBinaryFromReader);
    ...
    case 7:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setRoundIsOver(value);
      break;
    case 8:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setDivisionIsOver(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.liwords.TournamentDivisionDataResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.liwords.ClassicDivision.serializeBinaryToWriter
    );
  }
 ...
 * @return {string}
 */
proto.liwords.TournamentDivisionDataResponse.prototype.getDivisionId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.liwords.TournamentDivisionDataResponse} returns this
 */
proto.liwords.TournamentDivisionDataResponse.prototype.setDivisionId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Array<string>}
 */
proto.liwords.TournamentDivisionDataResponse.prototype.getPlayersList = function() {
 ...
 * @return {!proto.liwords.TournamentDivisionDataResponse} returns this
 */
proto.liwords.TournamentDivisionDataResponse.prototype.setPlayersList = function(value) {
  return jspb.Message.setField(this, 3, value || []);
};
 ...
 * @return {!proto.liwords.TournamentDivisionDataResponse} returns this
 */
proto.liwords.TournamentDivisionDataResponse.prototype.addPlayers = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 3, value, opt_index);
};
...
/**
 * optional ClassicDivision division = 5;
 * @return {?proto.liwords.ClassicDivision}
 */
proto.liwords.TournamentDivisionDataResponse.prototype.getDivision = function() {
  return /** @type{?proto.liwords.ClassicDivision} */ (
    jspb.Message.getWrapperField(this, proto.liwords.ClassicDivision, 5));
};


/**
 * @param {?proto.liwords.ClassicDivision|undefined} value
 * @return {!proto.liwords.TournamentDivisionDataResponse} returns this
*/
 ...
 * @return {!proto.liwords.TournamentDivisionDataResponse} returns this
 */
proto.liwords.TournamentDivisionDataResponse.prototype.clearDivision = function() {
 ...
 * @return {boolean}
 */
proto.liwords.TournamentDivisionDataResponse.prototype.hasDivision = function() {
  return jspb.Message.getField(this, 5) != null;
};


/**
 * optional int32 current_round = 6;
 * @return {number}
 */
...
/**
 * optional bool round_is_over = 7;
 * @return {boolean}
 */
proto.liwords.TournamentDivisionDataResponse.prototype.getRoundIsOver = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 7, false));
};
 ...
 * @return {!proto.liwords.TournamentDivisionDataResponse} returns this
 */
proto.liwords.TournamentDivisionDataResponse.prototype.setRoundIsOver = function(value) {
  return jspb.Message.setProto3BooleanField(this, 7, value);
};


/**
 * optional bool division_is_over = 8;
 * @return {boolean}
 */
proto.liwords.TournamentDivisionDataResponse.prototype.getDivisionIsOver = function() {
 ...
 * @return {!proto.liwords.TournamentDivisionDataResponse} returns this
 */
proto.liwords.TournamentDivisionDataResponse.prototype.setDivisionIsOver = function(value) {
 ...
 * @const
 */
proto.liwords.TournamentDataResponse.repeatedFields_ = [5];
...
proto.liwords.TournamentDataResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    directorsList: (f = jspb.Message.getRepeatedField(msg, 5)) == null ? undefined : f,
 ...
 * @return {!Array<string>}
 */
proto.liwords.TournamentDataResponse.prototype.getDirectorsList = function() {
 ...
 * @return {!proto.liwords.TournamentDataResponse} returns this
 */
proto.liwords.TournamentDataResponse.prototype.setDirectorsList = function(value) {
 ...
 * @return {!proto.liwords.TournamentDataResponse} returns this
 */
proto.liwords.TournamentDataResponse.prototype.addDirectors = function(value, opt_index) {
 ...
 * @return {!proto.liwords.TournamentDataResponse} returns this
 */
proto.liwords.TournamentDataResponse.prototype.clearDirectorsList = function() {
