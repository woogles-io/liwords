...
proto.macondo.GameHistory = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.macondo.GameHistory.repeatedFields_,
    null
  );
};
...
proto.macondo.GameTurn = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.macondo.GameTurn.repeatedFields_,
    null
  );
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.macondo.GameHistory.prototype.toObject = function (
    opt_includeInstance
  ) {
  ...
  proto.macondo.GameHistory.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        turnsList: jspb.Message.toObjectList(
          msg.getTurnsList(),
          proto.macondo.GameTurn.toObject,
          includeInstance
        ),
        playersList: jspb.Message.toObjectList(
          msg.getPlayersList(),
          proto.macondo.PlayerInfo.toObject,
          includeInstance
        ),
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.macondo.GameTurn.deserializeBinaryFromReader
        );
        msg.addTurns(value);
        break;
      case 2:
        ...
        reader.readMessage(
          value,
          proto.macondo.PlayerInfo.deserializeBinaryFromReader
        );
...
proto.macondo.GameHistory.prototype.getTurnsList = function () {
  return /** @type{!Array<!proto.macondo.GameTurn>} */ (jspb.Message.getRepeatedWrapperField(
    this,
    proto.macondo.GameTurn,
    1
  ));
};
...
proto.macondo.GameHistory.prototype.getPlayersList = function () {
  return /** @type{!Array<!proto.macondo.PlayerInfo>} */ (jspb.Message.getRepeatedWrapperField(
    this,
    proto.macondo.PlayerInfo,
    2
  ));
};
 ...
 */
proto.macondo.GameHistory.prototype.addPlayers = function (
  opt_value,
  opt_index
) {
  return jspb.Message.addToRepeatedWrapperField(
 ...
 * @return {!proto.macondo.GameHistory} returns this
 */
proto.macondo.GameHistory.prototype.addLastKnownRacks = function (
  value,
  opt_index
) {
...
/**
 * optional bool flip_players = 11;
 * @return {boolean}
 */
proto.macondo.GameHistory.prototype.getFlipPlayers = function () {
...
proto.macondo.GameEvent.prototype.getType = function () {
  return /** @type {!proto.macondo.GameEvent.Type} */ (jspb.Message.getFieldWithDefault(
    this,
    4,
    0
  ));
...
proto.macondo.GameEvent.prototype.getDirection = function () {
  return /** @type {!proto.macondo.GameEvent.Direction} */ (jspb.Message.getFieldWithDefault(
    this,
    8,
    0
  ));
    ...
    var f,
      obj = {
        eventsList: jspb.Message.toObjectList(
          msg.getEventsList(),
          proto.macondo.GameEvent.toObject,
          includeInstance
        ),
      };
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.macondo.GameEvent.deserializeBinaryFromReader
        );
        msg.addEvents(value);
        break;
      default:
...
proto.macondo.GameTurn.prototype.getEventsList = function () {
  return /** @type{!Array<!proto.macondo.GameEvent>} */ (jspb.Message.getRepeatedWrapperField(
    this,
    proto.macondo.GameEvent,
    1
  ));
};
