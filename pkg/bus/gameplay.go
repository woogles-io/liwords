...
func (b *Bus) handleBotMoveInternally(ctx context.Context, g *entity.Game, onTurn int, userID string) {
	...
	for g.PlayerOnTurn() == onTurn && g.Game.Playing() != macondopb.PlayState_GAME_OVER {
		...
		case *macondopb.BotResponse_Move:
			...
			err = gameplay.PlayMove(ctx, g, b.gameStore, b.userStore, b.notorietyStore, b.actionHistoryStore, b.listStatStore, b.tournamentStore, userID, onTurn, timeRemaining, m)
			if err != nil {
...
func (b *Bus) adjudicateGames(ctx context.Context) error {
	...
	for _, g := range gs.GameInfo {
		...
		if started && timeRanOut {
			...
			err = gameplay.TimedOut(ctx, b.gameStore, b.userStore, b.notorietyStore, b.actionHistoryStore,
...
func (b *Bus) gameMetaEvent(ctx context.Context, evt *pb.GameMetaEvent, userID string) error {
	...
	return gameplay.HandleMetaEvent(ctx, evt, b.gameEventChan, b.gameStore, b.userStore, b.notorietyStore, b.actionHistoryStore, b.listStatStore, b.tournamentStore)
}
