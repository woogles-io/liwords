...
func TestStandings(t *testing.T) {
	...
	assertFactorPairings(is, pairings[2], []int{0, 2, 1, 3})
	assertFactorPairings(is, pairings[3], []int{0, 2, 1, 3})
	assertFactorPairings(is, pairings[4], []int{0, 2, 1, 3})
	assertFactorPairings(is, pairings[5], []int{0, 2, 1, 3})
	assertFactorPairings(is, pairings[6], []int{0, 2, 1, 3})
	assertFactorPairings(is, pairings[7], []int{0, 2, 1, 3})
	assertFactorPairings(is, pairings[8], []int{0, 2, 1, 3})
	assertFactorPairings(is, pairings[9], []int{0, 1, 2, 3})
	...
	assertFactorPairings(is, pairings[2], []int{0, 3, 1, 4, 2, 5})
	assertFactorPairings(is, pairings[3], []int{0, 3, 1, 4, 2, 5})
	assertFactorPairings(is, pairings[4], []int{0, 3, 1, 4, 2, 5})
	assertFactorPairings(is, pairings[5], []int{0, 3, 1, 4, 2, 5})
	assertFactorPairings(is, pairings[6], []int{0, 3, 1, 4, 2, 5})
	assertFactorPairings(is, pairings[7], []int{0, 3, 1, 4, 2, 5})
	assertFactorPairings(is, pairings[8], []int{0, 2, 1, 3, 4, 5})
	assertFactorPairings(is, pairings[9], []int{0, 1, 2, 3, 4, 5})
