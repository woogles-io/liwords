...
func TestInitialFontes(t *testing.T) {
	...
	roundToPairingsMap := map[string][]int{
		...
		"5:16:0": []int{14, 15, 12, 13, 10, 11, 8, 9, 6, 7, 4, 5, 2, 3, 0, 1},
		"5:16:1": []int{4, 5, 6, 7, 0, 1, 2, 3, 14, 15, 12, 13, 10, 11, 8, 9},
		"5:16:2": []int{8, 9, 14, 15, 12, 13, 10, 11, 0, 1, 6, 7, 4, 5, 2, 3},
		"5:16:3": []int{12, 13, 8, 9, 6, 7, 4, 5, 2, 3, 14, 15, 0, 1, 10, 11},
		"5:16:4": []int{2, 3, 0, 1, 14, 15, 12, 13, 10, 11, 8, 9, 6, 7, 4, 5},
