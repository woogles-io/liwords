...
//go:embed letterdistributions/slovene
var sloveneLetterDistributionCSVBytes []byte
...
//go:embed tiles-spanish.png
var spanishTilesBytes []byte

//go:embed tiles-slovene.png
var sloveneTilesBytes []byte
...
var tilesMeta = map[string]*TilePainterTilesMeta{
	...
	"spanish": {
		...
		Tile0Src: map[byte][2]int{
			...
			16: {1020, 0}, 17: {1088, 0}, 18: {1156, 0}, 19: {1224, 0}, 20: {1292, 0},
			21: {0, 68}, 22: {68, 68}, 23: {136, 68}, 24: {204, 68}, 25: {272, 68},
			26: {340, 68}, 27: {408, 68}, 28: {476, 68}, 129: {544, 68}, 130: {612, 68},
			131: {680, 68}, 132: {748, 68}, 133: {816, 68}, 134: {884, 68}, 135: {952, 68},
			136: {1020, 68}, 137: {1088, 68}, 138: {1156, 68}, 139: {1224, 68}, 140: {1292, 68},
			141: {0, 136}, 142: {68, 136}, 143: {136, 136}, 144: {204, 136}, 145: {272, 136},
			146: {340, 136}, 147: {408, 136}, 148: {476, 136}, 149: {544, 136}, 150: {612, 136},
			151: {680, 136}, 152: {748, 136}, 153: {816, 136}, 154: {884, 136}, 155: {952, 136},
			156: {1020, 136}, 0: {1088, 136},
		},
		Tile1Src: map[byte][2]int{
			1: {1156, 136}, 2: {1224, 136}, 3: {1292, 136},
			4: {0, 204}, 5: {68, 204}, 6: {136, 204}, 7: {204, 204}, 8: {272, 204},
			9: {340, 204}, 10: {408, 204}, 11: {476, 204}, 12: {544, 204}, 13: {612, 204},
			14: {680, 204}, 15: {748, 204}, 16: {816, 204}, 17: {884, 204}, 18: {952, 204},
			19: {1020, 204}, 20: {1088, 204}, 21: {1156, 204}, 22: {1224, 204}, 23: {1292, 204},
			24: {0, 272}, 25: {68, 272}, 26: {136, 272}, 27: {204, 272}, 28: {272, 272},
			129: {340, 272}, 130: {408, 272}, 131: {476, 272}, 132: {544, 272}, 133: {612, 272},
			134: {680, 272}, 135: {748, 272}, 136: {816, 272}, 137: {884, 272}, 138: {952, 272},
			139: {1020, 272}, 140: {1088, 272}, 141: {1156, 272}, 142: {1224, 272}, 143: {1292, 272},
			144: {0, 340}, 145: {68, 340}, 146: {136, 340}, 147: {204, 340}, 148: {272, 340},
			149: {340, 340}, 150: {408, 340}, 151: {476, 340}, 152: {544, 340}, 153: {612, 340},
			154: {680, 340}, 155: {748, 340}, 156: {816, 340}, 0: {884, 340},
		},
		BoardSrc: map[rune][2]int{
			'-': {952, 340},
			'=': {1020, 340}, '~': {1088, 340}, '\'': {1156, 340}, '"': {1224, 340}, '^': {1292, 340},
			'*': {0, 408}, ' ': {68, 408},
		},
		TextXSrc: map[rune][2]int{
			'0': {0, 476}, '1': {24, 476}, '2': {48, 476}, '3': {72, 476}, '4': {96, 476},
			'5': {120, 476}, '6': {144, 476}, '7': {168, 476}, '8': {192, 476}, '9': {216, 476},
			'A': {240, 476}, 'a': {264, 476}, 'B': {288, 476}, 'b': {312, 476}, 'C': {336, 476},
			'c': {360, 476}, '[': {384, 476}, 'H': {408, 476}, ']': {432, 476}, 'h': {456, 476},
			'D': {480, 476}, 'd': {504, 476}, 'E': {528, 476}, 'e': {552, 476}, 'F': {576, 476},
			'f': {600, 476}, 'G': {624, 476}, 'g': {648, 476}, 'I': {672, 476}, 'i': {696, 476},
			'J': {720, 476}, 'j': {744, 476}, 'L': {768, 476}, 'l': {792, 476}, 'M': {816, 476},
			'm': {840, 476}, 'N': {864, 476}, 'n': {888, 476}, 'Ñ': {912, 476}, 'ñ': {936, 476},
			'O': {960, 476}, 'o': {984, 476}, 'P': {1008, 476}, 'p': {1032, 476}, 'Q': {1056, 476},
			'q': {1080, 476}, 'R': {1104, 476}, 'r': {1128, 476}, 'S': {1152, 476}, 's': {1176, 476},
			'T': {1200, 476}, 't': {1224, 476}, 'U': {1248, 476}, 'u': {1272, 476}, 'V': {1296, 476},
			'v': {1320, 476},
			'X': {0, 536}, 'x': {24, 536}, 'Y': {48, 536}, 'y': {72, 536}, 'Z': {96, 536},
			'z': {120, 536}, ' ': {144, 536}, '!': {168, 536}, '"': {192, 536}, '#': {216, 536},
			'$': {240, 536}, '%': {264, 536}, '&': {288, 536}, '\'': {312, 536}, '(': {336, 536},
			')': {360, 536}, '*': {384, 536}, '+': {408, 536}, ',': {432, 536}, '-': {456, 536},
			'.': {480, 536}, '/': {504, 536}, ':': {528, 536}, ';': {552, 536}, '<': {576, 536},
			'=': {600, 536}, '>': {624, 536}, '?': {648, 536}, '@': {672, 536}, 'K': {696, 536},
			'W': {720, 536}, '\\': {744, 536}, '^': {768, 536}, '_': {792, 536}, '`': {816, 536},
			'k': {840, 536}, 'w': {864, 536}, '{': {888, 536}, '|': {912, 536}, '}': {936, 536},
			'~': {960, 536},
		},
		Text0Src: map[rune][2]int{
			'0': {984, 536}, '1': {1008, 536}, '2': {1032, 536}, '3': {1056, 536},
			'4': {1080, 536}, '5': {1104, 536}, '6': {1128, 536}, '7': {1152, 536}, '8': {1176, 536},
			'9': {1200, 536}, 'A': {1224, 536}, 'a': {1248, 536}, 'B': {1272, 536}, 'b': {1296, 536},
			'C': {1320, 536},
			'c': {0, 596}, '[': {24, 596}, 'H': {48, 596}, ']': {72, 596}, 'h': {96, 596},
			'D': {120, 596}, 'd': {144, 596}, 'E': {168, 596}, 'e': {192, 596}, 'F': {216, 596},
			'f': {240, 596}, 'G': {264, 596}, 'g': {288, 596}, 'I': {312, 596}, 'i': {336, 596},
			'J': {360, 596}, 'j': {384, 596}, 'L': {408, 596}, 'l': {432, 596}, 'M': {456, 596},
			'm': {480, 596}, 'N': {504, 596}, 'n': {528, 596}, 'Ñ': {552, 596}, 'ñ': {576, 596},
			'O': {600, 596}, 'o': {624, 596}, 'P': {648, 596}, 'p': {672, 596}, 'Q': {696, 596},
			'q': {720, 596}, 'R': {744, 596}, 'r': {768, 596}, 'S': {792, 596}, 's': {816, 596},
			'T': {840, 596}, 't': {864, 596}, 'U': {888, 596}, 'u': {912, 596}, 'V': {936, 596},
			'v': {960, 596}, 'X': {984, 596}, 'x': {1008, 596}, 'Y': {1032, 596}, 'y': {1056, 596},
			'Z': {1080, 596}, 'z': {1104, 596}, ' ': {1128, 596}, '!': {1152, 596}, '"': {1176, 596},
			'#': {1200, 596}, '$': {1224, 596}, '%': {1248, 596}, '&': {1272, 596}, '\'': {1296, 596},
			'(': {1320, 596},
			')': {0, 656}, '*': {24, 656}, '+': {48, 656}, ',': {72, 656}, '-': {96, 656},
			'.': {120, 656}, '/': {144, 656}, ':': {168, 656}, ';': {192, 656}, '<': {216, 656},
			'=': {240, 656}, '>': {264, 656}, '?': {288, 656}, '@': {312, 656}, 'K': {336, 656},
			'W': {360, 656}, '\\': {384, 656}, '^': {408, 656}, '_': {432, 656}, '`': {456, 656},
			'k': {480, 656}, 'w': {504, 656}, '{': {528, 656}, '|': {552, 656}, '}': {576, 656},
			'~': {600, 656},
		},
		Text1Src: map[rune][2]int{
			'0': {624, 656}, '1': {648, 656}, '2': {672, 656}, '3': {696, 656},
			'4': {720, 656}, '5': {744, 656}, '6': {768, 656}, '7': {792, 656}, '8': {816, 656},
			'9': {840, 656}, 'A': {864, 656}, 'a': {888, 656}, 'B': {912, 656}, 'b': {936, 656},
			'C': {960, 656}, 'c': {984, 656}, '[': {1008, 656}, 'H': {1032, 656}, ']': {1056, 656},
			'h': {1080, 656}, 'D': {1104, 656}, 'd': {1128, 656}, 'E': {1152, 656}, 'e': {1176, 656},
			'F': {1200, 656}, 'f': {1224, 656}, 'G': {1248, 656}, 'g': {1272, 656}, 'I': {1296, 656},
			'i': {1320, 656},
			'J': {0, 716}, 'j': {24, 716}, 'L': {48, 716}, 'l': {72, 716}, 'M': {96, 716},
			'm': {120, 716}, 'N': {144, 716}, 'n': {168, 716}, 'Ñ': {192, 716}, 'ñ': {216, 716},
			'O': {240, 716}, 'o': {264, 716}, 'P': {288, 716}, 'p': {312, 716}, 'Q': {336, 716},
			'q': {360, 716}, 'R': {384, 716}, 'r': {408, 716}, 'S': {432, 716}, 's': {456, 716},
			'T': {480, 716}, 't': {504, 716}, 'U': {528, 716}, 'u': {552, 716}, 'V': {576, 716},
			'v': {600, 716}, 'X': {624, 716}, 'x': {648, 716}, 'Y': {672, 716}, 'y': {696, 716},
			'Z': {720, 716}, 'z': {744, 716}, ' ': {768, 716}, '!': {792, 716}, '"': {816, 716},
			'#': {840, 716}, '$': {864, 716}, '%': {888, 716}, '&': {912, 716}, '\'': {936, 716},
			'(': {960, 716}, ')': {984, 716}, '*': {1008, 716}, '+': {1032, 716}, ',': {1056, 716},
			'-': {1080, 716}, '.': {1104, 716}, '/': {1128, 716}, ':': {1152, 716}, ';': {1176, 716},
			'<': {1200, 716}, '=': {1224, 716}, '>': {1248, 716}, '?': {1272, 716}, '@': {1296, 716},
			'K': {1320, 716},
			'W': {0, 776}, '\\': {24, 776}, '^': {48, 776}, '_': {72, 776}, '`': {96, 776},
			'k': {120, 776}, 'w': {144, 776}, '{': {168, 776}, '|': {192, 776}, '}': {216, 776},
			'~': {240, 776},
		},
		ExpDimXY:    [2]int{1360, 836},
		BoardConfig: standardBoardConfig,
	...
	"slovene": {
		...
		TextXSrc: map[rune][2]int{
			...
			'5': {120, 476}, '6': {144, 476}, '7': {168, 476}, '8': {192, 476}, '9': {216, 476},
			'A': {240, 476}, 'a': {264, 476}, 'B': {288, 476}, 'b': {312, 476}, 'C': {336, 476},
			'c': {360, 476}, 'Č': {384, 476}, 'č': {408, 476}, 'D': {432, 476}, 'd': {456, 476},
			'E': {480, 476}, 'e': {504, 476}, 'F': {528, 476}, 'f': {552, 476}, 'G': {576, 476},
			'g': {600, 476}, 'H': {624, 476}, 'h': {648, 476}, 'I': {672, 476}, 'i': {696, 476},
			'J': {720, 476}, 'j': {744, 476}, 'K': {768, 476}, 'k': {792, 476}, 'L': {816, 476},
			'l': {840, 476}, 'M': {864, 476}, 'm': {888, 476}, 'N': {912, 476}, 'n': {936, 476},
			'O': {960, 476}, 'o': {984, 476}, 'P': {1008, 476}, 'p': {1032, 476}, 'Q': {1056, 476},
			'q': {1080, 476}, 'R': {1104, 476}, 'r': {1128, 476}, 'S': {1152, 476}, 's': {1176, 476},
			'Š': {1200, 476}, 'š': {1224, 476}, 'T': {1248, 476}, 't': {1272, 476}, 'U': {1296, 476},
			'u': {1320, 476},
			'V': {0, 536}, 'v': {24, 536}, 'W': {48, 536}, 'w': {72, 536}, 'X': {96, 536},
			'x': {120, 536}, 'Y': {144, 536}, 'y': {168, 536}, 'Z': {192, 536}, 'z': {216, 536},
			'Ž': {240, 536}, 'ž': {264, 536}, ' ': {288, 536}, '!': {312, 536}, '"': {336, 536},
			'#': {360, 536}, '$': {384, 536}, '%': {408, 536}, '&': {432, 536}, '\'': {456, 536},
			'(': {480, 536}, ')': {504, 536}, '*': {528, 536}, '+': {552, 536}, ',': {576, 536},
			'-': {600, 536}, '.': {624, 536}, '/': {648, 536}, ':': {672, 536}, ';': {696, 536},
			'<': {720, 536}, '=': {744, 536}, '>': {768, 536}, '?': {792, 536}, '@': {816, 536},
		...
		Text0Src: map[rune][2]int{
			...
			'5': {1200, 536}, '6': {1224, 536}, '7': {1248, 536}, '8': {1272, 536}, '9': {1296, 536},
			'A': {1320, 536},
			'a': {0, 596}, 'B': {24, 596}, 'b': {48, 596}, 'C': {72, 596}, 'c': {96, 596},
			'Č': {120, 596}, 'č': {144, 596}, 'D': {168, 596}, 'd': {192, 596}, 'E': {216, 596},
			'e': {240, 596}, 'F': {264, 596}, 'f': {288, 596}, 'G': {312, 596}, 'g': {336, 596},
			'H': {360, 596}, 'h': {384, 596}, 'I': {408, 596}, 'i': {432, 596}, 'J': {456, 596},
			'j': {480, 596}, 'K': {504, 596}, 'k': {528, 596}, 'L': {552, 596}, 'l': {576, 596},
			'M': {600, 596}, 'm': {624, 596}, 'N': {648, 596}, 'n': {672, 596}, 'O': {696, 596},
			'o': {720, 596}, 'P': {744, 596}, 'p': {768, 596}, 'Q': {792, 596}, 'q': {816, 596},
			'R': {840, 596}, 'r': {864, 596}, 'S': {888, 596}, 's': {912, 596}, 'Š': {936, 596},
			'š': {960, 596}, 'T': {984, 596}, 't': {1008, 596}, 'U': {1032, 596}, 'u': {1056, 596},
			'V': {1080, 596}, 'v': {1104, 596}, 'W': {1128, 596}, 'w': {1152, 596}, 'X': {1176, 596},
			'x': {1200, 596}, 'Y': {1224, 596}, 'y': {1248, 596}, 'Z': {1272, 596}, 'z': {1296, 596},
			'Ž': {1320, 596},
			'ž': {0, 656}, ' ': {24, 656}, '!': {48, 656}, '"': {72, 656}, '#': {96, 656},
			'$': {120, 656}, '%': {144, 656}, '&': {168, 656}, '\'': {192, 656}, '(': {216, 656},
			')': {240, 656}, '*': {264, 656}, '+': {288, 656}, ',': {312, 656}, '-': {336, 656},
			'.': {360, 656}, '/': {384, 656}, ':': {408, 656}, ';': {432, 656}, '<': {456, 656},
			'=': {480, 656}, '>': {504, 656}, '?': {528, 656}, '@': {552, 656}, '[': {576, 656},
		...
		Text1Src: map[rune][2]int{
			...
			'1': {840, 656}, '2': {864, 656}, '3': {888, 656}, '4': {912, 656}, '5': {936, 656},
			'6': {960, 656}, '7': {984, 656}, '8': {1008, 656}, '9': {1032, 656}, 'A': {1056, 656},
			'a': {1080, 656}, 'B': {1104, 656}, 'b': {1128, 656}, 'C': {1152, 656}, 'c': {1176, 656},
			'Č': {1200, 656}, 'č': {1224, 656}, 'D': {1248, 656}, 'd': {1272, 656}, 'E': {1296, 656},
			'e': {1320, 656},
			'F': {0, 716}, 'f': {24, 716}, 'G': {48, 716}, 'g': {72, 716}, 'H': {96, 716},
			'h': {120, 716}, 'I': {144, 716}, 'i': {168, 716}, 'J': {192, 716}, 'j': {216, 716},
			'K': {240, 716}, 'k': {264, 716}, 'L': {288, 716}, 'l': {312, 716}, 'M': {336, 716},
			'm': {360, 716}, 'N': {384, 716}, 'n': {408, 716}, 'O': {432, 716}, 'o': {456, 716},
			'P': {480, 716}, 'p': {504, 716}, 'Q': {528, 716}, 'q': {552, 716}, 'R': {576, 716},
			'r': {600, 716}, 'S': {624, 716}, 's': {648, 716}, 'Š': {672, 716}, 'š': {696, 716},
			'T': {720, 716}, 't': {744, 716}, 'U': {768, 716}, 'u': {792, 716}, 'V': {816, 716},
			'v': {840, 716}, 'W': {864, 716}, 'w': {888, 716}, 'X': {912, 716}, 'x': {936, 716},
			'Y': {960, 716}, 'y': {984, 716}, 'Z': {1008, 716}, 'z': {1032, 716}, 'Ž': {1056, 716},
			'ž': {1080, 716}, ' ': {1104, 716}, '!': {1128, 716}, '"': {1152, 716}, '#': {1176, 716},
			'$': {1200, 716}, '%': {1224, 716}, '&': {1248, 716}, '\'': {1272, 716}, '(': {1296, 716},
			')': {1320, 716},
			'*': {0, 776}, '+': {24, 776}, ',': {48, 776}, '-': {72, 776}, '.': {96, 776},
			'/': {120, 776}, ':': {144, 776}, ';': {168, 776}, '<': {192, 776}, '=': {216, 776},
...
func init() {
	...
	for _, entry := range []struct {
		...
		{name: "slovene", csvBytes: sloveneLetterDistributionCSVBytes},
	} {
