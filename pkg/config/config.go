...
func (c *Config) Load(args []string) error {
	...
	fs.StringVar(&c.MacondoConfig.StrategyParamsPath, "strategy-params-path", "./data/strategy", "directory holding strategy files")
	fs.StringVar(&c.MacondoConfig.LexiconPath, "lexicon-path", "./data/lexica", "directory holding lexicon files")
