// Package game implements the rules for playing a crossword board game.
package game
...
func playMove(ctx context.Context, gdoc *ipc.GameRecord, gevt *ipc.GameEvent, tr int64) error {
